...
class RecoAnalyser {
   private:
    ...
    // ======================================================================================================================================================================
    // Input FillHistogramByProcessing
    // ======================================================================================================================================================================

    //<editor-fold desc="Input FillHistogramByProcessing">
    /* Initial input FillHistogramByProcessing of loaded files (given by AnalyseFile) */
    ...
    */
    ...
    settings.ConfigureStatuses(apply_cuts, clas12ana_particles, only_preselection_cuts, apply_chi2_cuts_1e_cut, only_electron_quality_cuts, apply_nucleon_cuts, Enable_FD_photons,
                               apply_nucleon_SmearAndCorr, apply_kinematical_cuts, apply_kinematical_weights, apply_fiducial_cuts, Generate_AMaps, plot_and_fit_MomRes, VaryingDelta,
    ...
    nRes.MomResInit(plot_and_fit_MomRes, Calculate_momResS2, Run_with_momResS2, VaryingSampleName, NucleonCutsDirectory, beamE, FD_nucleon_momentum_cut, n_mom_th.GetLowerCut(),
    ...
    pRes.MomResInit(plot_and_fit_MomRes, Calculate_momResS2, Run_with_momResS2, VaryingSampleName, NucleonCutsDirectory, beamE, FD_nucleon_momentum_cut, p_mom_th.GetLowerCut(),
    ...
    hPlot1D hP_LnFD_APIDandNS_1e_cut_ZOOMOUT_FD =
        hPlot1D("1e_cut", "FD", "Leading FD neutron momentum APID&NC - ZOOMOUT", "Leading FD neutron momentum P_{n} APID&NC - ZOOMOUT", "P_{n} [GeV/c]",
                directories.Momentum_Directory_map["Momentum_1e_cut_Directory"], "08f_P_LnFD_APIDandNS_1e_cut_ZOOMOUT_FD", Momentum_lboundary, 15.,
    ...
    hPlot2D hP_e_vs_Theta_e_reco_1e_cut_FD =
        hPlot2D("1e cut", "FD", "P_{e} vs. #theta_{e}", "P_{e} vs. #theta_{e}", "P_{e} [GeV/c]", "#theta_{e} [Deg]", directories.Momentum_Directory_map["Momentum_th_reco_1e_cut_Directory"],
                "01c_P_e_vs_Theta_e_reco_1e_cut_FD", Momentum_lboundary, Momentum_uboundary, Theta_lboundary_FD, Theta_uboundary_FD, numTH2Dbins * 2, numTH2Dbins * 2);
    ...
    hPlot2D hP_p_vs_Theta_p_reco_1e_cut_FD =
        hPlot2D("1e cut", "FD", "P_{p} vs. #theta_{p}", "P_{p} vs. #theta_{p}", "P_{p} [GeV/c]", "#theta_{p} [Deg]", directories.Momentum_Directory_map["Momentum_th_reco_1e_cut_Directory"],
                "02c_P_p_vs_Theta_p_reco_1e_cut_FD", Momentum_lboundary, Momentum_uboundary, Theta_lboundary_FD, Theta_uboundary_FD, numTH2Dbins * 2, numTH2Dbins * 2);
    hPlot2D hP_p_vs_Theta_p_reco_1e_cut_CD =
        hPlot2D("1e cut", "CD", "P_{p} vs. #theta_{p}", "P_{p} vs. #theta_{p}", "P_{p} [GeV/c]", "#theta_{p} [Deg]", directories.Momentum_Directory_map["Momentum_th_reco_1e_cut_Directory"],
                "02d_P_p_vs_Theta_p_reco_1e_cut_CD", CDMomentum_lboundary, CDMomentum_uboundary, Theta_lboundary_CD, Theta_uboundary_CD, numTH2Dbins * 2, numTH2Dbins * 2);
    ...
    hPlot2D hP_LnFD_vs_Theta_LnFD_reco_APID_1e_cut_FD =
        hPlot2D("1e cut", "FD", "P_{LnFD} vs. #theta_{LnFD} APID", "P_{LnFD} vs. #theta_{LnFD} APID", "P_{LnFD} [GeV/c]", "#theta_{LnFD} [Deg]",
    ...
    hPlot2D hP_LnFD_vs_Theta_LnFD_reco_BPID_1e_cut_FD =
        hPlot2D("1e cut", "FD", "P_{LnFD} vs. #theta_{LnFD} BPID", "P_{LnFD} vs. #theta_{LnFD} BPID", "P_{LnFD} [GeV/c]", "#theta_{LnFD} [Deg]",
    ...
    hPlot2D hP_nFD_vs_Theta_nFD_reco_APID_1e_cut_FD = hPlot2D("1e cut", "FD", "P_{nFD} vs. #theta_{nFD} APID", "P_{nFD} vs. #theta_{nFD} APID", "P_{nFD} [GeV/c]", "#theta_{nFD} [Deg]",
    ...
    hPlot2D hP_nFD_vs_Theta_nFD_reco_BPID_1e_cut_FD = hPlot2D("1e cut", "FD", "P_{nFD} vs. #theta_{nFD} BPID", "P_{nFD} vs. #theta_{nFD} BPID", "P_{nFD} [GeV/c]", "#theta_{nFD} [Deg]",
    ...
    hPlot2D hP_piplus_vs_Theta_piplus_reco_1e_cut_FD =
        hPlot2D("1e cut", "FD", "P_{#pi^{+}} vs. #theta_{#pi^{+}}", "P_{#pi^{+}} vs. #theta_{#pi^{+}}", "P_{#pi^{+}} [GeV/c]", "#theta_{#pi^{+}} [Deg]",
    ...
    hPlot2D hP_piplus_vs_Theta_piplus_reco_1e_cut_CD =
        hPlot2D("1e cut", "CD", "P_{#pi^{+}} vs. #theta_{#pi^{+}}", "P_{#pi^{+}} vs. #theta_{#pi^{+}}", "P_{#pi^{+}} [GeV/c]", "#theta_{#pi^{+}} [Deg]",
    ...
    hPlot2D hP_ph_vs_Theta_ph_reco_APID_1e_cut_FD =
        hPlot2D("1e cut", "FD", "P_{#gamma} vs. #theta_{#gamma} APID", "P_{#gamma} vs. #theta_{#gamma} APID", "P_{#gamma} [GeV/c]", "#theta_{#gamma} [Deg]",
    ...
    hPlot2D hP_ph_vs_Theta_ph_reco_BPID_1e_cut_FD =
        hPlot2D("1e cut", "FD", "P_{#gamma} vs. #theta_{#gamma} BPID", "P_{#gamma} vs. #theta_{#gamma} BPID", "P_{#gamma} [GeV/c]", "#theta_{#gamma} [Deg]",
    ...
    hPlot1D hP_pFD_APID_1p = hPlot1D("1p", "FD", "FD proton momentum APID", "FD proton momentum APID", "P_{p} [GeV/c]",
                                     directories.Momentum_Directory_map["Analysis_plots_momentum_1p_Directory"], "01a_P_pFD_APID_1p_FD", Momentum_lboundary, Momentum_uboundary, numTH1Dbins);
    hPlot1D hP_pFD_APIDandPS_1p =
        hPlot1D("1p", "FD", "FD proton momentum APID&PS", "FD proton momentum APID&PS", "P_{p} [GeV/c]", directories.Momentum_Directory_map["Analysis_plots_momentum_1p_Directory"],
                "01b_P_pFD_APIDandPS_1p_FD", Momentum_lboundary, Momentum_uboundary, numTH1Dbins);
    ...
    hPlot1D hP_nFD_APID_1n = hPlot1D("1n", "FD", "Leading FD neutron momentum APID", "Leading FD neutron momentum APID", "P_{n} [GeV/c]",
                                     directories.Momentum_Directory_map["Analysis_plots_momentum_1n_Directory"], "01a_P_nFD_APID_1n_FD", Momentum_lboundary, Momentum_uboundary, numTH1Dbins);
    hPlot1D hP_nFD_APIDandNS_1n =
        hPlot1D("1n", "FD", "Leading FD neutron momentum APID&NC", "Leading FD neutron momentum APID&NC", "P_{n} [GeV/c]",
                directories.Momentum_Directory_map["Analysis_plots_momentum_1n_Directory"], "01b_P_nFD_APIDandNS_1n_FD", Momentum_lboundary, Momentum_uboundary, numTH1Dbins);
    ...
    hPlot1D hP_p_APID_pFDpCD_FD = hPlot1D("pFDpCD", "FD", "Proton momentum APID", "Proton momentum P_{p} APID", "P_{p} [GeV/c]",
                                          directories.Momentum_Directory_map["Momentum_pFDpCD_Directory"], "03c_P_p_APID_pFDpCD_FD", Momentum_lboundary, Momentum_uboundary, numTH1Dbins);
    hPlot1D hP_p_APIDandPS_pFDpCD_FD =
        hPlot1D("pFDpCD", "FD", "Proton momentum APID&PS", "Proton momentum P_{p} APID&PS", "P_{p} [GeV/c]", directories.Momentum_Directory_map["Momentum_pFDpCD_Directory"],
                "03d_P_p_APIDandPS_pFDpCD_FD", Momentum_lboundary, Momentum_uboundary, numTH1Dbins);
    ...
    hPlot1D hP_pFD_pFDpCD = hPlot1D("pFDpCD", "", "FD proton momentum", "FD proton momentum P_{pFD}", "P_{pFD} [GeV/c]",
                                    directories.Momentum_Directory_map["Analysis_plots_momentum_pFDpCD_Directory"], "01a_P_pFD_pFDpCD", Momentum_lboundary, Momentum_uboundary, numTH1Dbins);
    ...
    hPlot1D hP_nFD_nFDpCD = hPlot1D("nFDpCD", "", "FD neutron momentum", "FD neutron momentum P_{nFD}", "P_{nFD} [GeV/c]",
                                    directories.Momentum_Directory_map["Analysis_plots_momentum_nFDpCD_Directory"], "01a_P_nFD_nFDpCD", Momentum_lboundary, Momentum_uboundary, numTH1Dbins);
    ...
    hPlot1D hP_pL_pFDpCD = hPlot1D("pFDpCD", "", "Leading proton momentum", "Leading proton momentum", "P_{pL} [GeV/c]",
                                   directories.Momentum_Directory_map["Analysis_plots_momentum_pFDpCD_Directory"], "03a_P_pL_pFDpCD", Momentum_lboundary, Momentum_uboundary, numTH1Dbins);
    ...
    hPlot1D hP_nL_nFDpCD = hPlot1D("nFDpCD", "", "Leading nucleon momentum", "Leading nucleon momentum", "P_{nL} [GeV/c]",
                                   directories.Momentum_Directory_map["Analysis_plots_momentum_nFDpCD_Directory"], "03a_P_nL_nFDpCD", Momentum_lboundary, Momentum_uboundary, numTH1Dbins);
    ...
    TH1D *hW_All_Int_pFDpCD = new TH1D("W distribution (All Int., pFDpCD)", "W distribution (All Int., pFDpCD);W = #sqrt{(#omega + m_{p})^{2} - #vec{q}^{2}}  [GeV];", numTH1Dbins_W_Plots,
                                       W_lboundary, W_uboundary);
    TH1D *hW_QEL_pFDpCD = new TH1D("W distribution (QEL only, pFDpCD)", "W distribution (QEL only, pFDpCD);W = #sqrt{(#omega + m_{p})^{2} - #vec{q}^{2}}  [GeV];", numTH1Dbins_W_Plots,
                                   W_lboundary, W_uboundary);
    TH1D *hW_MEC_pFDpCD = new TH1D("W distribution (MEC only, pFDpCD)", "W distribution (MEC only, pFDpCD);W = #sqrt{(#omega + m_{p})^{2} - #vec{q}^{2}}  [GeV];", numTH1Dbins_W_Plots,
                                   W_lboundary, W_uboundary);
    TH1D *hW_RES_pFDpCD = new TH1D("W distribution (RES only, pFDpCD)", "W distribution (RES only, pFDpCD);W = #sqrt{(#omega + m_{p})^{2} - #vec{q}^{2}}  [GeV];", numTH1Dbins_W_Plots,
                                   W_lboundary, W_uboundary);
    ...
    TH1D *hW_All_Int_nFDpCD = new TH1D("W distribution (All Int., nFDpCD)", "W distribution (All Int., nFDpCD);W = #sqrt{(#omega + m_{p})^{2} - #vec{q}^{2}}  [GeV];", numTH1Dbins_W_Plots,
                                       W_lboundary, W_uboundary);
    TH1D *hW_QEL_nFDpCD = new TH1D("W distribution (QEL only, nFDpCD)", "W distribution (QEL only, nFDpCD);W = #sqrt{(#omega + m_{p})^{2} - #vec{q}^{2}}  [GeV];", numTH1Dbins_W_Plots,
                                   W_lboundary, W_uboundary);
    TH1D *hW_MEC_nFDpCD = new TH1D("W distribution (MEC only, nFDpCD)", "W distribution (MEC only, nFDpCD);W = #sqrt{(#omega + m_{p})^{2} - #vec{q}^{2}}  [GeV];", numTH1Dbins_W_Plots,
                                   W_lboundary, W_uboundary);
    TH1D *hW_RES_nFDpCD = new TH1D("W distribution (RES only, nFDpCD)", "W distribution (RES only, nFDpCD);W = #sqrt{(#omega + m_{p})^{2} - #vec{q}^{2}}  [GeV];", numTH1Dbins_W_Plots,
                                   W_lboundary, W_uboundary);
    ...
    TH1D *hTheta_e_All_Int_1p_FD =
        new TH1D("#theta_{e} (All Int., 1p, FD)", "#theta_{e} of Outgoing Electron (All Int., 1p, FD);#theta_{e} [Deg];", numTH1Dbins_Ang_Plots, Theta_lboundary_FD, Theta_uboundary_FD);
    TH1D *hTheta_e_QEL_1p_FD =
        new TH1D("#theta_{e} (QEL Only, 1p, FD)", "#theta_{e} of Outgoing Electron (QEL Only, 1p, FD);#theta_{e} [Deg];", numTH1Dbins_Ang_Plots, Theta_lboundary_FD, Theta_uboundary_FD);
    TH1D *hTheta_e_MEC_1p_FD =
        new TH1D("#theta_{e} (MEC Only, 1p, FD)", "#theta_{e} of Outgoing Electron (MEC Only, 1p, FD);#theta_{e} [Deg];", numTH1Dbins_Ang_Plots, Theta_lboundary_FD, Theta_uboundary_FD);
    ...
    TH1D *hTheta_e_All_Int_1n_FD =
        new TH1D("#theta_{e} (All Int., 1n, FD)", "#theta_{e} of Outgoing Electron (All Int., 1n, FD);#theta_{e} [Deg];", numTH1Dbins_Ang_Plots, Theta_lboundary_FD, Theta_uboundary_FD);
    TH1D *hTheta_e_QEL_1n_FD =
        new TH1D("#theta_{e} (QEL Only, 1n, FD)", "#theta_{e} of Outgoing Electron (QEL Only, 1n, FD);#theta_{e} [Deg];", numTH1Dbins_Ang_Plots, Theta_lboundary_FD, Theta_uboundary_FD);
    TH1D *hTheta_e_MEC_1n_FD =
        new TH1D("#theta_{e} (MEC Only, 1n, FD)", "#theta_{e} of Outgoing Electron (MEC Only, 1n, FD);#theta_{e} [Deg];", numTH1Dbins_Ang_Plots, Theta_lboundary_FD, Theta_uboundary_FD);
    ...
    TH1D *hTheta_e_All_Int_2p_FD =
        new TH1D("#theta_{e} (All Int., 2p, FD)", "#theta_{e} of Outgoing Electron (All Int., 2p, FD);#theta_{e} [Deg];", numTH1Dbins_Ang_Plots, Theta_lboundary_FD, Theta_uboundary_FD);
    TH1D *hTheta_e_QEL_2p_FD =
        new TH1D("#theta_{e} (QEL Only, 2p, FD)", "#theta_{e} of Outgoing Electron (QEL Only, 2p, FD);#theta_{e} [Deg];", numTH1Dbins_Ang_Plots, Theta_lboundary_FD, Theta_uboundary_FD);
    TH1D *hTheta_e_MEC_2p_FD =
        new TH1D("#theta_{e} (MEC Only, 2p, FD)", "#theta_{e} of Outgoing Electron (MEC Only, 2p, FD);#theta_{e} [Deg];", numTH1Dbins_Ang_Plots, Theta_lboundary_FD, Theta_uboundary_FD);
    ...
    TH1D *hTheta_e_All_Int_pFDpCD_FD = new TH1D("#theta_{e} (All Int., pFDpCD, FD)", "#theta_{e} of Outgoing Electron (All Int., pFDpCD, FD);#theta_{e} [Deg];", numTH1Dbins_Ang_Plots,
                                                Theta_lboundary_FD, Theta_uboundary_FD);
    TH1D *hTheta_e_QEL_pFDpCD_FD = new TH1D("#theta_{e} (QEL Only, pFDpCD, FD)", "#theta_{e} of Outgoing Electron (QEL Only, pFDpCD, FD);#theta_{e} [Deg];", numTH1Dbins_Ang_Plots,
                                            Theta_lboundary_FD, Theta_uboundary_FD);
    TH1D *hTheta_e_MEC_pFDpCD_FD = new TH1D("#theta_{e} (MEC Only, pFDpCD, FD)", "#theta_{e} of Outgoing Electron (MEC Only, pFDpCD, FD);#theta_{e} [Deg];", numTH1Dbins_Ang_Plots,
                                            Theta_lboundary_FD, Theta_uboundary_FD);
    TH1D *hTheta_e_RES_pFDpCD_FD = new TH1D("#theta_{e} (RES Only, pFDpCD, FD)", "#theta_{e} of Outgoing Electron (RES Only, pFDpCD, FD);#theta_{e} [Deg];", numTH1Dbins_Ang_Plots,
                                            Theta_lboundary_FD, Theta_uboundary_FD);
    ...
    TH1D *hTheta_e_All_Int_nFDpCD_FD = new TH1D("#theta_{e} (All Int., nFDpCD, FD)", "#theta_{e} of Outgoing Electron (All Int., nFDpCD, FD);#theta_{e} [Deg];", numTH1Dbins_Ang_Plots,
                                                Theta_lboundary_FD, Theta_uboundary_FD);
    TH1D *hTheta_e_QEL_nFDpCD_FD = new TH1D("#theta_{e} (QEL Only, nFDpCD, FD)", "#theta_{e} of Outgoing Electron (QEL Only, nFDpCD, FD);#theta_{e} [Deg];", numTH1Dbins_Ang_Plots,
                                            Theta_lboundary_FD, Theta_uboundary_FD);
    TH1D *hTheta_e_MEC_nFDpCD_FD = new TH1D("#theta_{e} (MEC Only, nFDpCD, FD)", "#theta_{e} of Outgoing Electron (MEC Only, nFDpCD, FD);#theta_{e} [Deg];", numTH1Dbins_Ang_Plots,
                                            Theta_lboundary_FD, Theta_uboundary_FD);
    TH1D *hTheta_e_RES_nFDpCD_FD = new TH1D("#theta_{e} (RES Only, nFDpCD, FD)", "#theta_{e} of Outgoing Electron (RES Only, nFDpCD, FD);#theta_{e} [Deg];", numTH1Dbins_Ang_Plots,
                                            Theta_lboundary_FD, Theta_uboundary_FD);
    ...
    TH1D *hPhi_e_All_Int_1p_FD =
        new TH1D("#phi_{e} 1p (All Int., FD)", "#phi_{e} of Outgoing Electron (All Int., 1p, FD);#phi_{e} [Deg];", numTH1Dbins_Ang_Plots, Phi_lboundary, Phi_uboundary);
    TH1D *hPhi_e_QEL_1p_FD =
        new TH1D("#phi_{e} for 1p (QEL Only, FD)", "#phi_{e} of Outgoing Electron (QEL Only, 1p, FD);#phi_{e} [Deg];", numTH1Dbins_Ang_Plots, Phi_lboundary, Phi_uboundary);
    TH1D *hPhi_e_MEC_1p_FD =
        new TH1D("#phi_{e} for 1p (MEC Only, FD)", "#phi_{e} of Outgoing Electron (MEC Only, 1p, FD);#phi_{e} [Deg];", numTH1Dbins_Ang_Plots, Phi_lboundary, Phi_uboundary);
    ...
    TH1D *hPhi_e_All_Int_1n_FD =
        new TH1D("#phi_{e} 1n (All Int., FD)", "#phi_{e} of Outgoing Electron (All Int., 1n, FD);#phi_{e} [Deg];", numTH1Dbins_Ang_Plots, Phi_lboundary, Phi_uboundary);
    TH1D *hPhi_e_QEL_1n_FD =
        new TH1D("#phi_{e} for 1n (QEL Only, FD)", "#phi_{e} of Outgoing Electron (QEL Only, 1n, FD);#phi_{e} [Deg];", numTH1Dbins_Ang_Plots, Phi_lboundary, Phi_uboundary);
    TH1D *hPhi_e_MEC_1n_FD =
        new TH1D("#phi_{e} for 1n (MEC Only, FD)", "#phi_{e} of Outgoing Electron (MEC Only, 1n, FD);#phi_{e} [Deg];", numTH1Dbins_Ang_Plots, Phi_lboundary, Phi_uboundary);
    ...
    TH1D *hPhi_e_All_Int_2p_FD =
        new TH1D("#phi_{e} 2p (All Int., FD)", "#phi_{e} of Outgoing Electron (All Int., 2p, FD);#phi_{e} [Deg];", numTH1Dbins_Ang_Plots, Phi_lboundary, Phi_uboundary);
    TH1D *hPhi_e_QEL_2p_FD =
        new TH1D("#phi_{e} for 2p (QEL Only, FD)", "#phi_{e} of Outgoing Electron (QEL Only, 2p, FD);#phi_{e} [Deg];", numTH1Dbins_Ang_Plots, Phi_lboundary, Phi_uboundary);
    TH1D *hPhi_e_MEC_2p_FD =
        new TH1D("#phi_{e} for 2p (MEC Only, FD)", "#phi_{e} of Outgoing Electron (MEC Only, 2p, FD);#phi_{e} [Deg];", numTH1Dbins_Ang_Plots, Phi_lboundary, Phi_uboundary);
    ...
    TH1D *hPhi_e_All_Int_pFDpCD_FD =
        new TH1D("#phi_{e} pFDpCD (All Int., FD)", "#phi_{e} of Outgoing Electron (All Int., pFDpCD, FD);#phi_{e} [Deg];", numTH1Dbins_Ang_Plots, Phi_lboundary, Phi_uboundary);
    TH1D *hPhi_e_QEL_pFDpCD_FD =
        new TH1D("#phi_{e} for pFDpCD (QEL Only, FD)", "#phi_{e} of Outgoing Electron (QEL Only, pFDpCD, FD);#phi_{e} [Deg];", numTH1Dbins_Ang_Plots, Phi_lboundary, Phi_uboundary);
    TH1D *hPhi_e_MEC_pFDpCD_FD =
        new TH1D("#phi_{e} for pFDpCD (MEC Only, FD)", "#phi_{e} of Outgoing Electron (MEC Only, pFDpCD, FD);#phi_{e} [Deg];", numTH1Dbins_Ang_Plots, Phi_lboundary, Phi_uboundary);
    ...
    TH1D *hPhi_e_All_Int_nFDpCD_FD =
        new TH1D("#phi_{e} nFDpCD (All Int., FD)", "#phi_{e} of Outgoing Electron (All Int., nFDpCD, FD);#phi_{e} [Deg];", numTH1Dbins_Ang_Plots, Phi_lboundary, Phi_uboundary);
    TH1D *hPhi_e_QEL_nFDpCD_FD =
        new TH1D("#phi_{e} for nFDpCD (QEL Only, FD)", "#phi_{e} of Outgoing Electron (QEL Only, nFDpCD, FD);#phi_{e} [Deg];", numTH1Dbins_Ang_Plots, Phi_lboundary, Phi_uboundary);
    TH1D *hPhi_e_MEC_nFDpCD_FD =
        new TH1D("#phi_{e} for nFDpCD (MEC Only, FD)", "#phi_{e} of Outgoing Electron (MEC Only, nFDpCD, FD);#phi_{e} [Deg];", numTH1Dbins_Ang_Plots, Phi_lboundary, Phi_uboundary);
    ...
    hPlot2D hdTheta_n_e_VS_dPhi_n_e_Electrons_BV_1e_cut =
        hPlot2D("1e cut", "FD", "#Delta#theta_{n,e} vs. #Delta#phi_{n,e} BV", "'Neutron Hits' vs. Electron Hits - Before Veto", "#Delta#phi_{n,e} = #phi_{n}^{ECAL} - #phi_{e}^{ECAL} [Deg]",
                "#Delta#theta_{n,e} = #theta_{n}^{ECAL} - #theta_{e}^{ECAL} [Deg]", directories.Angle_Directory_map["Neutron_veto_1e_cut_Directory"],
                "01_Neutron_hits_vs_electron_hits_BV_1e_cut", -180, 180, -50, 50, 100, 100);
    hPlot2D hdTheta_n_p_VS_dPhi_n_p_Protons_BV_1e_cut =
        hPlot2D("1e cut", "FD", "#Delta#theta_{n,p} vs. #Delta#phi_{n,p} BV", "'Neutron Hits' vs. Proton Hits - Before Veto", "#Delta#phi_{n,p} = #phi_{n}^{ECAL} - #phi_{p}^{ECAL} [Deg]",
                "#Delta#theta_{n,p} = #theta_{n}^{ECAL} - #theta_{p}^{ECAL} [Deg]", directories.Angle_Directory_map["Neutron_veto_1e_cut_Directory"],
    ...
    hPlot2D hdTheta_LnFD_e_VS_dPhi_LnFD_e_Electrons_BV_1e_cut =
        hPlot2D("1e cut", "FD", "#Delta#theta_{LnFD,e} vs. #Delta#phi_{LnFD,e} BV", "'Leading Neutron Hits' vs. Electron Hits - Before Veto",
                "#Delta#phi_{LnFD,e} = #phi_{n}^{ECAL} - #phi_{e}^{ECAL} [Deg]", "#Delta#theta_{LnFD,e} = #theta_{n}^{ECAL} - #theta_{e}^{ECAL} [Deg]",
    ...
    hPlot2D hdTheta_nFD_e_VS_dPhi_nFD_e_Electrons_BV_1e_cut =
        hPlot2D("1e cut", "FD", "#Delta#theta_{nFD,e} vs. #Delta#phi_{nFD,e} BV", "'Neutron Hits' vs. Electron Hits - Before Veto",
                "#Delta#phi_{nFD,e} = #phi_{n}^{ECAL} - #phi_{e}^{ECAL} [Deg]", "#Delta#theta_{nFD,e} = #theta_{n}^{ECAL} - #theta_{e}^{ECAL} [Deg]",
    ...
    hPlot2D hdTheta_LnFD_p_VS_dPhi_LnFD_p_Protons_BV_1e_cut =
        hPlot2D("1e cut", "FD", "#Delta#theta_{LnFD,pFD} vs. #Delta#phi_{LnFD,pFD} BV", "'Leading Neutron Hits' vs. Proton Hits - Before Veto",
                "#Delta#phi_{LnFD,pFD} = #phi_{n}^{ECAL} - #phi_{pFD}^{ECAL} [Deg]", "#Delta#theta_{LnFD,pFD} = #theta_{n}^{ECAL} - #theta_{pFD}^{ECAL} [Deg]",
    ...
    hPlot2D hdTheta_nFD_p_VS_dPhi_nFD_p_Protons_BV_1e_cut =
        hPlot2D("1e cut", "FD", "#Delta#theta_{nFD,pFD} vs. #Delta#phi_{nFD,pFD} BV", "'Neutron Hits' vs. Proton Hits - Before Veto",
                "#Delta#phi_{nFD,pFD} = #phi_{n}^{ECAL} - #phi_{pFD}^{ECAL} [Deg]", "#Delta#theta_{nFD,pFD} = #theta_{n}^{ECAL} - #theta_{pFD}^{ECAL} [Deg]",
    ...
    hPlot2D hdTheta_n_e_VS_dPhi_n_e_Electrons_BV_1n =
        hPlot2D("1n", "FD", "#Delta#theta_{n,e} vs. #Delta#phi_{n,e} BV", "'Neutron Hits' vs. Electron Hits - Before Veto", "#Delta#phi_{n,e} = #phi_{n}^{ECAL} - #phi_{e}^{ECAL} [Deg]",
                "#Delta#theta_{n,e} = #theta_{n}^{ECAL} - #theta_{e}^{ECAL} [Deg]", directories.Angle_Directory_map["Neutron_veto_1n_Directory"], "01_Neutron_hits_vs_electron_hits_BV_1n",
                -180, 180, -50, 50, 65, 65);
    hPlot2D hdTheta_n_e_VS_dPhi_n_e_Electrons_AV_1n =
        hPlot2D("1n", "FD", "#Delta#theta_{n,e} vs. #Delta#phi_{n,e} AV", "'Neutron Hits' vs. Electron Hits - After Veto", "#Delta#phi_{n,e} = #phi_{n}^{ECAL} - #phi_{e}^{ECAL} [Deg]",
                "#Delta#theta_{n,e} = #theta_{n}^{ECAL} - #theta_{e}^{ECAL} [Deg]", directories.Angle_Directory_map["Neutron_veto_1n_Directory"], "02_Neutron_hits_vs_electron_hits_AV_1n",
                -180, 180, -50, 50, 65, 65);
    hPlot2D hdTheta_n_e_VS_dPhi_n_e_Electrons_Vetoed_Neutrons_1n =
        hPlot2D("1n", "FD", "#Delta#theta_{n,e} vs. #Delta#phi_{n,e}", "'Neutron Hits' vs. Electron Hits - Vetoed Neutrons", "#Delta#phi_{n,e} = #phi_{n}^{ECAL} - #phi_{e}^{ECAL} [Deg]",
                "#Delta#theta_{n,e} = #theta_{n}^{ECAL} - #theta_{e}^{ECAL} [Deg]", directories.Angle_Directory_map["Neutron_veto_1n_Directory"],
    ...
    THStack *sTheta_p_e_p_tot_2p = new THStack(
        "#theta_{#vec{P}_{e},#vec{P}_{tot}} (All Int., 2p)",
    ...
    THStack *sTheta_q_p_2p =
        new THStack("#theta_{#vec{q},#vec{P}} (All Int., 2p)", "#theta_{#vec{q},#vec{P}} - Opening Angle Between #vec{q} and #vec{P} (All Int., 2p);#theta_{#vec{q},#vec{P}} [Deg];");
    ...
    THStack *sTheta_p1_p2_2p = new THStack("#theta_{p_{1},p_{2}} (All Int., stack, 2p)", "#theta_{p_{1},p_{2}} - Opening Angle Between Protons (2p);#theta_{p_{1},p_{2}} [Deg];");
    TH1D *hTheta_p1_p2_All_Int_2p =
        new TH1D("#theta_{p_{1},p_{2}} (All Int., 2p)", "#theta_{p_{1},p_{2}} - Opening Angle Between Protons (All Int., 2p);#theta_{p_{1},p_{2}} [Deg];", numTH1Dbins_Ang_Plots, 0, 180);
    TH1D *hTheta_p1_p2_QEL_2p =
        new TH1D("#theta_{p_{1},p_{2}} (QEL only, 2p)", "#theta_{p_{1},p_{2}} - Opening Angle Between Protons (QEL only, 2p);#theta_{p_{1},p_{2}} [Deg];", numTH1Dbins_Ang_Plots, 0, 180);
    TH1D *hTheta_p1_p2_MEC_2p =
        new TH1D("#theta_{p_{1},p_{2}} (MEC only, 2p)", "#theta_{p_{1},p_{2}} - Opening Angle Between Protons (MEC only, 2p);#theta_{p_{1},p_{2}} [Deg];", numTH1Dbins_Ang_Plots, 0, 180);
    ...
    hPlot2D hTheta_p1_p2_VS_ToF1_ToF2_AC_2p =
        hPlot2D("2p", "CD-CTOF", "#theta_{p_{1},p_{2}} vs. ToF_{1}-ToF_{2} AC", "#theta_{p_{1},p_{2}} vs. ToF_{1}-ToF_{2} AC", "#theta_{p_{1},p_{2}} [Deg]", "ToF_{1}-ToF_{2} [ns]",
    ...
    hPlot2D hTheta_p1_p2_VS_Pos1_Pos2_AC_2p = hPlot2D("2p", "CD-CTOF", "#theta_{p_{1},p_{2}} vs. Position_{1}-Position_{2} AC", "#theta_{p_{1},p_{2}} vs. Position_{1}-Position_{2} AC",
                                                      "#theta_{p_{1},p_{2}} [Deg]", "Position_{1}-Position_{2} [cm]", directories.Angle_Directory_map["CToF_hits_2p_Directory"],
    ...
    TH1D *hTheta_pFD_All_Int_pFDpCD_FD =
        new TH1D("#theta_{pFD} (All Int., pFDpCD)", "#theta_{pFD} of FD proton (All Int., pFDpCD);#theta_{pFD} [Deg];", numTH1Dbins_Ang_Plots, Theta_lboundary_FD, Theta_uboundary_FD);
    TH1D *hTheta_pFD_QEL_pFDpCD_FD =
        new TH1D("#theta_{pFD} (QEL Only, pFDpCD)", "#theta_{pFD} of FD proton (QEL Only, pFDpCD);#theta_{pFD} [Deg];", numTH1Dbins_Ang_Plots, Theta_lboundary_FD, Theta_uboundary_FD);
    TH1D *hTheta_pFD_MEC_pFDpCD_FD =
        new TH1D("#theta_{pFD} (MEC Only, pFDpCD)", "#theta_{pFD} of FD proton (MEC Only, pFDpCD);#theta_{pFD} [Deg];", numTH1Dbins_Ang_Plots, Theta_lboundary_FD, Theta_uboundary_FD);
    ...
    TH1D *hPhi_pFD_All_Int_pFDpCD_FD =
        new TH1D("#phi_{pFD} (All Int., pFDpCD)", "#phi_{pFD} of FD proton (All Int., pFDpCD);#phi_{pFD} [Deg];", numTH1Dbins_Ang_Plots, Phi_lboundary, Phi_uboundary);
    TH1D *hPhi_pFD_QEL_pFDpCD_FD =
        new TH1D("#phi_{pFD} (QEL Only, pFDpCD)", "#phi_{pFD} of FD proton (QEL Only, pFDpCD);#phi_{pFD} [Deg];", numTH1Dbins_Ang_Plots, Phi_lboundary, Phi_uboundary);
    TH1D *hPhi_pFD_MEC_pFDpCD_FD =
        new TH1D("#phi_{pFD} (MEC Only, pFDpCD)", "#phi_{pFD} of FD proton (MEC Only, pFDpCD);#phi_{pFD} [Deg];", numTH1Dbins_Ang_Plots, Phi_lboundary, Phi_uboundary);
    ...
    TH1D *hTheta_pCD_All_Int_pFDpCD_CD = new TH1D("#theta_{pCD} (All Int., pFDpCD)", "#theta_{pCD} of CD proton (All Int., pFDpCD);#theta_{pCD} [Deg];", numTH1Dbins_Ang_Plots, 30, 155);
    TH1D *hTheta_pCD_QEL_pFDpCD_CD = new TH1D("#theta_{pCD} (QEL Only, pFDpCD)", "#theta_{pCD} of CD proton (QEL Only, pFDpCD);#theta_{pCD} [Deg];", numTH1Dbins_Ang_Plots, 30, 155);
    ...
    TH1D *hPhi_pCD_All_Int_pFDpCD_CD =
        new TH1D("#phi_{pCD} (All Int., pFDpCD)", "#phi_{pCD} of CD proton (All Int., pFDpCD);#phi_{pCD} [Deg];", numTH1Dbins_Ang_Plots, Phi_lboundary, Phi_uboundary);
    TH1D *hPhi_pCD_QEL_pFDpCD_CD =
        new TH1D("#phi_{pCD} (QEL Only, pFDpCD)", "#phi_{pCD} of CD proton (QEL Only, pFDpCD);#phi_{pCD} [Deg];", numTH1Dbins_Ang_Plots, Phi_lboundary, Phi_uboundary);
    TH1D *hPhi_pCD_MEC_pFDpCD_CD =
        new TH1D("#phi_{pCD} (MEC Only, pFDpCD)", "#phi_{pCD} of CD proton (MEC Only, pFDpCD);#phi_{pCD} [Deg];", numTH1Dbins_Ang_Plots, Phi_lboundary, Phi_uboundary);
    ...
    TH1D *hTheta_tot_All_Int_pFDpCD = new TH1D("#theta_{tot} (All Int., pFDpCD)", "#theta_{tot} of total 3-momentum (All Int., pFDpCD);#theta_{tot} [Deg];", numTH1Dbins_Ang_Plots,
    ...
    TH1D *hPhi_tot_All_Int_pFDpCD =
        new TH1D("#phi_{tot} (All Int., pFDpCD)", "#phi_{tot} of total 3-momentum (All Int., pFDpCD);#phi_{tot} [Deg];", numTH1Dbins_Ang_Plots, Phi_lboundary, Phi_uboundary);
    TH1D *hPhi_tot_QEL_pFDpCD =
        new TH1D("#phi_{tot} (QEL Only, pFDpCD)", "#phi_{tot} of total 3-momentum (QEL Only, pFDpCD);#phi_{tot} [Deg];", numTH1Dbins_Ang_Plots, Phi_lboundary, Phi_uboundary);
    TH1D *hPhi_tot_MEC_pFDpCD =
        new TH1D("#phi_{tot} (MEC Only, pFDpCD)", "#phi_{tot} of total 3-momentum (MEC Only, pFDpCD);#phi_{tot} [Deg];", numTH1Dbins_Ang_Plots, Phi_lboundary, Phi_uboundary);
    ...
    TH1D *hTheta_rel_All_Int_pFDpCD =
        new TH1D("#theta_{rel} (All Int., pFDpCD)", "#theta_{rel} of relative 3-momentum (All Int., pFDpCD);#theta_{rel} [Deg];", numTH1Dbins_Ang_Plots, 30, 155);
    TH1D *hTheta_rel_QEL_pFDpCD = new TH1D("#theta_{rel} (QEL Only, pFDpCD)", "#theta_{rel} of relative 3-momentum (QEL Only, pFDpCD);#theta_{rel} [Deg];", numTH1Dbins_Ang_Plots, 30, 155);
    ...
    TH1D *hPhi_rel_All_Int_pFDpCD =
        new TH1D("#phi_{rel} (All Int., pFDpCD)", "#phi_{rel} of relative 3-momentum (All Int., pFDpCD);#phi_{rel} [Deg];", numTH1Dbins_Ang_Plots, Phi_lboundary, Phi_uboundary);
    TH1D *hPhi_rel_QEL_pFDpCD =
        new TH1D("#phi_{rel} (QEL Only, pFDpCD)", "#phi_{rel} of relative 3-momentum (QEL Only, pFDpCD);#phi_{rel} [Deg];", numTH1Dbins_Ang_Plots, Phi_lboundary, Phi_uboundary);
    TH1D *hPhi_rel_MEC_pFDpCD =
        new TH1D("#phi_{rel} (MEC Only, pFDpCD)", "#phi_{rel} of relative 3-momentum (MEC Only, pFDpCD);#phi_{rel} [Deg];", numTH1Dbins_Ang_Plots, Phi_lboundary, Phi_uboundary);
    ...
    THStack *sTheta_q_p_L_R_pFDpCD =
        new THStack("#theta_{#vec{q},#vec{P}} (All Int., pFDpCD)", "#theta_{#vec{q},#vec{P}} - Opening Angle Between #vec{q} and #vec{P} (All Int., pFDpCD);#theta_{#vec{q},#vec{P}} [Deg];");
    ...
    TH1D *hTheta_pFD_pCD_All_Int_pFDpCD =
        new TH1D("#theta_{pFD,pCD} (All Int., pFDpCD)", "#theta_{pFD,pCD} - Opening Angle Between Protons (All Int., pFDpCD);#theta_{pFD,pCD} [Deg];", numTH1Dbins_Ang_Plots, 0, 180);
    TH1D *hTheta_pFD_pCD_QEL_pFDpCD =
        new TH1D("#theta_{pFD,pCD} (QEL only, pFDpCD)", "#theta_{pFD,pCD} - Opening Angle Between Protons (QEL only, pFDpCD);#theta_{pFD,pCD} [Deg];", numTH1Dbins_Ang_Plots, 0, 180);
    TH1D *hTheta_pFD_pCD_MEC_pFDpCD =
        new TH1D("#theta_{pFD,pCD} (MEC only, pFDpCD)", "#theta_{pFD,pCD} - Opening Angle Between Protons (MEC only, pFDpCD);#theta_{pFD,pCD} [Deg];", numTH1Dbins_Ang_Plots, 0, 180);
    ...
    hPlot2D hTheta_pFD_pCD_VS_ToFpFD_ToFpCD_AC_pFDpCD =
        hPlot2D("pFDpCD", "CD-CTOF", "#theta_{pFD,pCD} vs. ToF_{pFD}-ToF_{pCD} AC", "#theta_{pFD,pCD} vs. ToF_{pFD}-ToF_{pCD} AC", "#theta_{pFD,pCD} [Deg]", "ToF_{pFD}-ToF_{pCD} [ns]",
    ...
    hPlot2D hTheta_pFD_pCD_VS_PospFD_PospCD_AC_pFDpCD =
        hPlot2D("pFDpCD", "CD-CTOF", "#theta_{pFD,pCD} vs. Position_{pFD}-Position_{pCD} AC", "#theta_{pFD,pCD} vs. Position_{pFD}-Position_{pCD} AC", "#theta_{pFD,pCD} [Deg]",
    ...
    TH1D *hTheta_nFD_All_Int_nFDpCD_FD =
        new TH1D("#theta_{nFD} (All Int., nFDpCD)", "#theta_{nFD} of FD neutron (All Int., nFDpCD);#theta_{nFD} [Deg];", numTH1Dbins_Ang_Plots, Theta_lboundary_FD, Theta_uboundary_FD);
    TH1D *hTheta_nFD_QEL_nFDpCD_FD =
        new TH1D("#theta_{nFD} (QEL Only, nFDpCD)", "#theta_{nFD} of FD neutron (QEL Only, nFDpCD);#theta_{nFD} [Deg];", numTH1Dbins_Ang_Plots, Theta_lboundary_FD, Theta_uboundary_FD);
    TH1D *hTheta_nFD_MEC_nFDpCD_FD =
        new TH1D("#theta_{nFD} (MEC Only, nFDpCD)", "#theta_{nFD} of FD neutron (MEC Only, nFDpCD);#theta_{nFD} [Deg];", numTH1Dbins_Ang_Plots, Theta_lboundary_FD, Theta_uboundary_FD);
    ...
    TH1D *hPhi_nFD_All_Int_nFDpCD_FD =
        new TH1D("#phi_{nFD} (All Int., nFDpCD)", "#phi_{nFD} of FD neutron (All Int., nFDpCD);#phi_{nFD} [Deg];", numTH1Dbins_Ang_Plots, Phi_lboundary, Phi_uboundary);
    TH1D *hPhi_nFD_QEL_nFDpCD_FD =
        new TH1D("#phi_{nFD} (QEL Only, nFDpCD)", "#phi_{nFD} of FD neutron (QEL Only, nFDpCD);#phi_{nFD} [Deg];", numTH1Dbins_Ang_Plots, Phi_lboundary, Phi_uboundary);
    TH1D *hPhi_nFD_MEC_nFDpCD_FD =
        new TH1D("#phi_{nFD} (MEC Only, nFDpCD)", "#phi_{nFD} of FD neutron (MEC Only, nFDpCD);#phi_{nFD} [Deg];", numTH1Dbins_Ang_Plots, Phi_lboundary, Phi_uboundary);
    ...
    TH1D *hTheta_pCD_All_Int_nFDpCD_CD = new TH1D("#theta_{pCD} (All Int., nFDpCD)", "#theta_{pCD} of CD proton (All Int., nFDpCD);#theta_{pCD} [Deg];", numTH1Dbins_Ang_Plots, 30, 155);
    TH1D *hTheta_pCD_QEL_nFDpCD_CD = new TH1D("#theta_{pCD} (QEL Only, nFDpCD)", "#theta_{pCD} of CD proton (QEL Only, nFDpCD);#theta_{pCD} [Deg];", numTH1Dbins_Ang_Plots, 30, 155);
    ...
    TH1D *hPhi_pCD_All_Int_nFDpCD_CD =
        new TH1D("#phi_{pCD} (All Int., nFDpCD)", "#phi_{pCD} of CD proton (All Int., nFDpCD);#phi_{pCD} [Deg];", numTH1Dbins_Ang_Plots, Phi_lboundary, Phi_uboundary);
    TH1D *hPhi_pCD_QEL_nFDpCD_CD =
        new TH1D("#phi_{pCD} (QEL Only, nFDpCD)", "#phi_{pCD} of CD proton (QEL Only, nFDpCD);#phi_{pCD} [Deg];", numTH1Dbins_Ang_Plots, Phi_lboundary, Phi_uboundary);
    TH1D *hPhi_pCD_MEC_nFDpCD_CD =
        new TH1D("#phi_{pCD} (MEC Only, nFDpCD)", "#phi_{pCD} of CD proton (MEC Only, nFDpCD);#phi_{pCD} [Deg];", numTH1Dbins_Ang_Plots, Phi_lboundary, Phi_uboundary);
    ...
    TH1D *hTheta_tot_All_Int_nFDpCD = new TH1D("#theta_{tot} (All Int., nFDpCD)", "#theta_{tot} of total 3-momentum (All Int., nFDpCD);#theta_{tot} [Deg];", numTH1Dbins_Ang_Plots,
                                               Opening_Ang_narrow_lboundary, Opening_Ang_narrow_uboundary);
    ...
    TH1D *hPhi_tot_All_Int_nFDpCD =
        new TH1D("#phi_{tot} (All Int., nFDpCD)", "#phi_{tot} of total 3-momentum (All Int., nFDpCD);#phi_{tot} [Deg];", numTH1Dbins_Ang_Plots, Phi_lboundary, Phi_uboundary);
    TH1D *hPhi_tot_QEL_nFDpCD =
        new TH1D("#phi_{tot} (QEL Only, nFDpCD)", "#phi_{tot} of total 3-momentum (QEL Only, nFDpCD);#phi_{tot} [Deg];", numTH1Dbins_Ang_Plots, Phi_lboundary, Phi_uboundary);
    TH1D *hPhi_tot_MEC_nFDpCD =
        new TH1D("#phi_{tot} (MEC Only, nFDpCD)", "#phi_{tot} of total 3-momentum (MEC Only, nFDpCD);#phi_{tot} [Deg];", numTH1Dbins_Ang_Plots, Phi_lboundary, Phi_uboundary);
    ...
    TH1D *hTheta_rel_All_Int_nFDpCD =
        new TH1D("#theta_{rel} (All Int., nFDpCD)", "#theta_{rel} of relative 3-momentum (All Int., nFDpCD);#theta_{rel} [Deg];", numTH1Dbins_Ang_Plots, 30, 155);
    TH1D *hTheta_rel_QEL_nFDpCD = new TH1D("#theta_{rel} (QEL Only, nFDpCD)", "#theta_{rel} of relative 3-momentum (QEL Only, nFDpCD);#theta_{rel} [Deg];", numTH1Dbins_Ang_Plots, 30, 155);
    ...
    TH1D *hPhi_rel_All_Int_nFDpCD =
        new TH1D("#phi_{rel} (All Int., nFDpCD)", "#phi_{rel} of relative 3-momentum (All Int., nFDpCD);#phi_{rel} [Deg];", numTH1Dbins_Ang_Plots, Phi_lboundary, Phi_uboundary);
    TH1D *hPhi_rel_QEL_nFDpCD =
        new TH1D("#phi_{rel} (QEL Only, nFDpCD)", "#phi_{rel} of relative 3-momentum (QEL Only, nFDpCD);#phi_{rel} [Deg];", numTH1Dbins_Ang_Plots, Phi_lboundary, Phi_uboundary);
    TH1D *hPhi_rel_MEC_nFDpCD =
        new TH1D("#phi_{rel} (MEC Only, nFDpCD)", "#phi_{rel} of relative 3-momentum (MEC Only, nFDpCD);#phi_{rel} [Deg];", numTH1Dbins_Ang_Plots, Phi_lboundary, Phi_uboundary);
    ...
    THStack *sTheta_q_p_L_R_nFDpCD =
        new THStack("#theta_{#vec{q},#vec{P}} (All Int., nFDpCD)", "#theta_{#vec{q},#vec{P}} - Opening Angle Between #vec{q} and #vec{P} (All Int., nFDpCD);#theta_{#vec{q},#vec{P}} [Deg];");
    ...
    TH1D *hTheta_nFD_pCD_All_Int_nFDpCD =
        new TH1D("#theta_{nFD,pCD} (All Int., nFDpCD)", "#theta_{nFD,pCD} - Opening Angle Between Protons (All Int., nFDpCD);#theta_{nFD,pCD} [Deg];", numTH1Dbins_Ang_Plots, 0, 180);
    TH1D *hTheta_nFD_pCD_QEL_nFDpCD =
        new TH1D("#theta_{nFD,pCD} (QEL only, nFDpCD)", "#theta_{nFD,pCD} - Opening Angle Between Protons (QEL only, nFDpCD);#theta_{nFD,pCD} [Deg];", numTH1Dbins_Ang_Plots, 0, 180);
    TH1D *hTheta_nFD_pCD_MEC_nFDpCD =
        new TH1D("#theta_{nFD,pCD} (MEC only, nFDpCD)", "#theta_{nFD,pCD} - Opening Angle Between Protons (MEC only, nFDpCD);#theta_{nFD,pCD} [Deg];", numTH1Dbins_Ang_Plots, 0, 180);
    ...
    hPlot2D hdTheta_nFD_e_VS_dPhi_nFD_e_Electrons_BV_nFDpCD =
        hPlot2D("nFDpCD", "FD", "#Delta#theta_{nFD,e} vs. #Delta#phi_{nFD,e} BV", "'Neutron Hits' vs. Electron Hits - Before Veto",
                "#Delta#phi_{nFD,e} = #phi_{nFD}^{ECAL} - #phi_{e}^{ECAL} [Deg]", "#Delta#theta_{nFD,e} = #theta_{nFD}^{ECAL} - #theta_{e}^{ECAL} [Deg]",
    ...
    TH2D *hE_e_VS_Theta_e_QEL_1e_cut_FD = new TH2D("E_{e} vs. #theta_{e} (QEL Only, 1e cut)", "E_{e} vs. #theta_{e} (QEL Only, 1e cut);#theta_{e} [Deg];E_{e} [GeV]", numTH2Dbins_E_e_Plots,
                                                   0, 50, numTH2Dbins_E_e_Plots, 0, beamE * 1.1);
    TH2D *hE_e_VS_Theta_e_MEC_1e_cut_FD = new TH2D("E_{e} vs. #theta_{e} (MEC Only, 1e cut)", "E_{e} vs. #theta_{e} (MEC Only, 1e cut);#theta_{e} [Deg];E_{e} [GeV]", numTH2Dbins_E_e_Plots,
                                                   0, 50, numTH2Dbins_E_e_Plots, 0, beamE * 1.1);
    TH2D *hE_e_VS_Theta_e_RES_1e_cut_FD = new TH2D("E_{e} vs. #theta_{e} (RES Only, 1e cut)", "E_{e} vs. #theta_{e} (RES Only, 1e cut);#theta_{e} [Deg];E_{e} [GeV]", numTH2Dbins_E_e_Plots,
                                                   0, 50, numTH2Dbins_E_e_Plots, 0, beamE * 1.1);
    ...
    TH2D *hE_e_VS_Theta_e_QEL_1p_FD = new TH2D("E_{e} vs. #theta_{e} (QEL Only, 1p)", "E_{e} vs. #theta_{e} (QEL Only, 1p);#theta_{e} [Deg];E_{e} [GeV]", numTH2Dbins_E_e_Plots, 0, 50,
                                               numTH2Dbins_E_e_Plots, 0, beamE * 1.1);
    TH2D *hE_e_VS_Theta_e_MEC_1p_FD = new TH2D("E_{e} vs. #theta_{e} (MEC Only, 1p)", "E_{e} vs. #theta_{e} (MEC Only, 1p);#theta_{e} [Deg];E_{e} [GeV]", numTH2Dbins_E_e_Plots, 0, 50,
                                               numTH2Dbins_E_e_Plots, 0, beamE * 1.1);
    TH2D *hE_e_VS_Theta_e_RES_1p_FD = new TH2D("E_{e} vs. #theta_{e} (RES Only, 1p)", "E_{e} vs. #theta_{e} (RES Only, 1p);#theta_{e} [Deg];E_{e} [GeV]", numTH2Dbins_E_e_Plots, 0, 50,
                                               numTH2Dbins_E_e_Plots, 0, beamE * 1.1);
    ...
    TH2D *hE_e_VS_Theta_e_All_Int_1n_FD = new TH2D("E_{e} vs. #theta_{e} (All Int., 1n)", "E_{e} vs. #theta_{e} (All Int., 1n);#theta_{e} [Deg];E_{e} [GeV]", numTH2Dbins_E_e_Plots, 0, 50,
                                                   numTH2Dbins_E_e_Plots, 0, beamE * 1.1);
    TH2D *hE_e_VS_Theta_e_QEL_1n_FD = new TH2D("E_{e} vs. #theta_{e} (QEL Only, 1n)", "E_{e} vs. #theta_{e} (QEL Only, 1n);#theta_{e} [Deg];E_{e} [GeV]", numTH2Dbins_E_e_Plots, 0, 50,
                                               numTH2Dbins_E_e_Plots, 0, beamE * 1.1);
    TH2D *hE_e_VS_Theta_e_MEC_1n_FD = new TH2D("E_{e} vs. #theta_{e} (MEC Only, 1n)", "E_{e} vs. #theta_{e} (MEC Only, 1n);#theta_{e} [Deg];E_{e} [GeV]", numTH2Dbins_E_e_Plots, 0, 50,
                                               numTH2Dbins_E_e_Plots, 0, beamE * 1.1);
    TH2D *hE_e_VS_Theta_e_RES_1n_FD = new TH2D("E_{e} vs. #theta_{e} (RES Only, 1n)", "E_{e} vs. #theta_{e} (RES Only, 1n);#theta_{e} [Deg];E_{e} [GeV]", numTH2Dbins_E_e_Plots, 0, 50,
                                               numTH2Dbins_E_e_Plots, 0, beamE * 1.1);
    ...
    TH2D *hE_e_VS_Theta_e_All_Int_2p_FD = new TH2D("E_{e} vs. #theta_{e} (All Int., 2p)", "E_{e} vs. #theta_{e} (All Int., 2p);#theta_{e} [Deg];E_{e} [GeV]", numTH2Dbins_E_e_Plots, 0, 50,
                                                   numTH2Dbins_E_e_Plots, 0, beamE * 1.1);
    TH2D *hE_e_VS_Theta_e_QEL_2p_FD = new TH2D("E_{e} vs. #theta_{e} (QEL Only, 2p)", "E_{e} vs. #theta_{e} (QEL Only, 2p);#theta_{e} [Deg];E_{e} [GeV]", numTH2Dbins_E_e_Plots, 0, 50,
                                               numTH2Dbins_E_e_Plots, 0, beamE * 1.1);
    TH2D *hE_e_VS_Theta_e_MEC_2p_FD = new TH2D("E_{e} vs. #theta_{e} (MEC Only, 2p)", "E_{e} vs. #theta_{e} (MEC Only, 2p);#theta_{e} [Deg];E_{e} [GeV]", numTH2Dbins_E_e_Plots, 0, 50,
                                               numTH2Dbins_E_e_Plots, 0, beamE * 1.1);
    TH2D *hE_e_VS_Theta_e_RES_2p_FD = new TH2D("E_{e} vs. #theta_{e} (RES Only, 2p)", "E_{e} vs. #theta_{e} (RES Only, 2p);#theta_{e} [Deg];E_{e} [GeV]", numTH2Dbins_E_e_Plots, 0, 50,
                                               numTH2Dbins_E_e_Plots, 0, beamE * 1.1);
    ...
    TH2D *hE_e_VS_Theta_e_All_Int_pFDpCD_FD = new TH2D("E_{e} vs. #theta_{e} (All Int., pFDpCD)", "E_{e} vs. #theta_{e} (All Int., pFDpCD);#theta_{e} [Deg];E_{e} [GeV]",
                                                       numTH2Dbins_E_e_Plots, 0, 50, numTH2Dbins_E_e_Plots, 0, beamE * 1.1);
    TH2D *hE_e_VS_Theta_e_QEL_pFDpCD_FD = new TH2D("E_{e} vs. #theta_{e} (QEL Only, pFDpCD)", "E_{e} vs. #theta_{e} (QEL Only, pFDpCD);#theta_{e} [Deg];E_{e} [GeV]", numTH2Dbins_E_e_Plots,
                                                   0, 50, numTH2Dbins_E_e_Plots, 0, beamE * 1.1);
    TH2D *hE_e_VS_Theta_e_MEC_pFDpCD_FD = new TH2D("E_{e} vs. #theta_{e} (MEC Only, pFDpCD)", "E_{e} vs. #theta_{e} (MEC Only, pFDpCD);#theta_{e} [Deg];E_{e} [GeV]", numTH2Dbins_E_e_Plots,
                                                   0, 50, numTH2Dbins_E_e_Plots, 0, beamE * 1.1);
    TH2D *hE_e_VS_Theta_e_RES_pFDpCD_FD = new TH2D("E_{e} vs. #theta_{e} (RES Only, pFDpCD)", "E_{e} vs. #theta_{e} (RES Only, pFDpCD);#theta_{e} [Deg];E_{e} [GeV]", numTH2Dbins_E_e_Plots,
                                                   0, 50, numTH2Dbins_E_e_Plots, 0, beamE * 1.1);
    ...
    TH2D *hE_e_VS_Theta_e_All_Int_nFDpCD_FD = new TH2D("E_{e} vs. #theta_{e} (All Int., nFDpCD)", "E_{e} vs. #theta_{e} (All Int., nFDpCD);#theta_{e} [Deg];E_{e} [GeV]",
                                                       numTH2Dbins_E_e_Plots, 0, 50, numTH2Dbins_E_e_Plots, 0, beamE * 1.1);
    TH2D *hE_e_VS_Theta_e_QEL_nFDpCD_FD = new TH2D("E_{e} vs. #theta_{e} (QEL Only, nFDpCD)", "E_{e} vs. #theta_{e} (QEL Only, nFDpCD);#theta_{e} [Deg];E_{e} [GeV]", numTH2Dbins_E_e_Plots,
                                                   0, 50, numTH2Dbins_E_e_Plots, 0, beamE * 1.1);
    TH2D *hE_e_VS_Theta_e_MEC_nFDpCD_FD = new TH2D("E_{e} vs. #theta_{e} (MEC Only, nFDpCD)", "E_{e} vs. #theta_{e} (MEC Only, nFDpCD);#theta_{e} [Deg];E_{e} [GeV]", numTH2Dbins_E_e_Plots,
                                                   0, 50, numTH2Dbins_E_e_Plots, 0, beamE * 1.1);
    TH2D *hE_e_VS_Theta_e_RES_nFDpCD_FD = new TH2D("E_{e} vs. #theta_{e} (RES Only, nFDpCD)", "E_{e} vs. #theta_{e} (RES Only, nFDpCD);#theta_{e} [Deg];E_{e} [GeV]", numTH2Dbins_E_e_Plots,
                                                   0, 50, numTH2Dbins_E_e_Plots, 0, beamE * 1.1);
    ...
    TH2D *hEcal_vs_Theta_e_1p = new TH2D("E_{cal} vs. #theta_{e} (All Int., 1p)", "E_{cal} vs. #theta_{e} (All Int., 1p);#theta_{e} [Deg];E_{cal} [GeV];", numTH2Dbins_E_cal_Plots,
                                         Theta_lboundary_FD, Theta_uboundary_FD, numTH2Dbins_E_cal_Plots, 0, beamE * 1.35);
    TH2D *hEcal_vs_Phi_e_1p = new TH2D("E_{cal} vs. #phi_{e} (All Int., 1p)", "E_{cal} vs. #phi_{e} (All Int., 1p);#phi_{e} [Deg];E_{cal} [GeV];", numTH2Dbins_E_cal_Plots, Phi_lboundary,
                                       Phi_uboundary, numTH2Dbins_E_cal_Plots, 0, beamE * 1.35);
    TH2D *hEcal_vs_Theta_e_test_1p =
        new TH2D("E_{cal} vs. #theta_{e} for E_{cal}>E_{beam} (All Int., 1p)", "E_{cal} vs. #theta_{e} for E_{cal}>E_{beam} (All Int., 1p);#theta_{e} [Deg];E_{cal} [GeV];",
    ...
    TH2D *hEcal_vs_Theta_p_1p = new TH2D("E_{cal} vs. #theta_{p} (All Int., 1p)", "E_{cal} vs. #theta_{p} (All Int., 1p);#theta_{p} [Deg];E_{cal} [GeV];", numTH2Dbins_E_cal_Plots,
                                         Theta_lboundary_FD, Theta_uboundary_FD, numTH2Dbins_E_cal_Plots, 0, beamE * 1.35);
    TH2D *hEcal_vs_Phi_p_1p = new TH2D("E_{cal} vs. #phi_{p} (All Int., 1p)", "E_{cal} vs. #phi_{p} (All Int., 1p);#phi_{p} [Deg];E_{cal} [GeV];", numTH2Dbins_E_cal_Plots, Phi_lboundary,
                                       Phi_uboundary, numTH2Dbins_E_cal_Plots, 0, beamE * 1.35);
    TH2D *hEcal_vs_Theta_p_test_1p =
        new TH2D("E_{cal} vs. #theta_{p} for E_{cal}>E_{beam} (All Int., 1p)", "E_{cal} vs. #theta_{p} for E_{cal}>E_{beam} (All Int., 1p);#theta_{p} [Deg];E_{cal} [GeV];",
                 numTH2Dbins_E_cal_Plots, Theta_lboundary_FD, Theta_uboundary_FD, numTH2Dbins_E_cal_Plots, 0, beamE * 1.35);
    ...
    TH2D *hEcal_vs_Theta_e_1n = new TH2D("E_{cal} vs. #theta_{e} (All Int., 1n)", "E_{cal} vs. #theta_{e} (All Int., 1n);#theta_{e} [Deg];E_{cal} [GeV];", numTH2Dbins_E_cal_Plots,
                                         Theta_lboundary_FD, Theta_uboundary_FD, numTH2Dbins_E_cal_Plots, 0, beamE * 1.35);
    TH2D *hEcal_vs_Phi_e_1n = new TH2D("E_{cal} vs. #phi_{e} (All Int., 1n)", "E_{cal} vs. #phi_{e} (All Int., 1n);#phi_{e} [Deg];E_{cal} [GeV];", numTH2Dbins_E_cal_Plots, Phi_lboundary,
                                       Phi_uboundary, numTH2Dbins_E_cal_Plots, 0, beamE * 1.35);
    TH2D *hEcal_vs_Theta_e_test_1n =
        new TH2D("E_{cal} vs. #theta_{e} for E_{cal}>E_{beam} (All Int., 1n)", "E_{cal} vs. #theta_{e} for E_{cal}>E_{beam} (All Int., 1n);#theta_{e} [Deg];E_{cal} [GeV];",
                 numTH2Dbins_E_cal_Plots, Theta_lboundary_FD, Theta_uboundary_FD, numTH2Dbins_E_cal_Plots, 0, beamE * 1.35);
    ...
    TH2D *hEcal_vs_Theta_n_1n = new TH2D("E_{cal} vs. #theta_{n} (All Int., 1n)", "E_{cal} vs. #theta_{n} (All Int., 1n);#theta_{n} [Deg];E_{cal} [GeV];", numTH2Dbins_E_cal_Plots,
                                         Theta_lboundary_FD, Theta_uboundary_FD, numTH2Dbins_E_cal_Plots, 0, beamE * 1.35);
    TH2D *hEcal_vs_Phi_n_1n = new TH2D("E_{cal} vs. #phi_{n} (All Int., 1n)", "E_{cal} vs. #phi_{n} (All Int., 1n);#phi_{n} [Deg];E_{cal} [GeV];", numTH2Dbins_E_cal_Plots, Phi_lboundary,
                                       Phi_uboundary, numTH2Dbins_E_cal_Plots, 0, beamE * 1.35);
    TH2D *hEcal_vs_Theta_n_test_1n =
        new TH2D("E_{cal} vs. #theta_{n} for E_{cal}>E_{beam} (All Int., 1n)", "E_{cal} vs. #theta_{n} for E_{cal}>E_{beam} (All Int., 1n);#theta_{n} [Deg];E_{cal} [GeV];",
                 numTH2Dbins_E_cal_Plots, Theta_lboundary_FD, Theta_uboundary_FD, numTH2Dbins_E_cal_Plots, 0, beamE * 1.35);
    ...
    TH2D *hEcal_vs_dAlpha_T_L_2p = new TH2D("E_{cal} vs. #delta#alpha_{T,L} (All Int., 2p)", "E_{cal} vs. #delta#alpha_{T,L} (All Int., 2p);#delta#alpha_{T,L} [Deg];E_{cal} [GeV];",
                                            numTH2Dbins_E_cal_Plots, 0, 180, numTH2Dbins_E_cal_Plots, 0, beamE * 1.35);
    ...
    TH2D *hEcal_vs_Theta_e_pFDpCD = new TH2D("E_{cal} vs. #theta_{e} (All Int., pFDpCD)", "E_{cal} vs. #theta_{e} (All Int., pFDpCD);#theta_{e} [Deg];E_{cal} [GeV];",
                                             numTH2Dbins_E_cal_Plots, Theta_lboundary_FD, Theta_uboundary_FD, numTH2Dbins_E_cal_Plots, 0, beamE * 1.35);
    TH2D *hEcal_vs_Phi_e_pFDpCD = new TH2D("E_{cal} vs. #phi_{e} (All Int., pFDpCD)", "E_{cal} vs. #phi_{e} (All Int., pFDpCD);#phi_{e} [Deg];E_{cal} [GeV];", numTH2Dbins_E_cal_Plots,
                                           Phi_lboundary, Phi_uboundary, numTH2Dbins_E_cal_Plots, 0, beamE * 1.35);
    TH2D *hEcal_vs_Theta_e_test_pFDpCD =
        new TH2D("E_{cal} vs. #theta_{e} for E_{cal}>E_{beam} (All Int., pFDpCD)", "E_{cal} vs. #theta_{e} for E_{cal}>E_{beam} (All Int., pFDpCD);#theta_{e} [Deg];E_{cal} [GeV];",
                 numTH2Dbins_E_cal_Plots, Theta_lboundary_FD, Theta_uboundary_FD, numTH2Dbins_E_cal_Plots, 0, beamE * 1.35);
    ...
    TH2D *hEcal_vs_Theta_pFD_test_pFDpCD =
        new TH2D("E_{cal} vs. #theta_{pFD} for E_{cal}>E_{beam} (All Int., pFDpCD)", "E_{cal} vs. #theta_{pFD} for E_{cal}>E_{beam} (All Int., pFDpCD);#theta_{pFD} [Deg];E_{cal} [GeV];",
                 numTH2Dbins_E_cal_Plots, Theta_lboundary_FD, Theta_uboundary_FD, numTH2Dbins_E_cal_Plots, 0, beamE * 1.35);
    ...
    TH2D *hEcal_vs_Theta_pCD_test_pFDpCD =
        new TH2D("E_{cal} vs. #theta_{pCD} for E_{cal}>E_{beam} (All Int., pFDpCD)", "E_{cal} vs. #theta_{pCD} for E_{cal}>E_{beam} (All Int., pFDpCD);#theta_{pCD} [Deg];E_{cal} [GeV];",
                 numTH2Dbins_E_cal_Plots, Theta_lboundary_CD, Theta_uboundary_CD, numTH2Dbins_E_cal_Plots, 0, beamE * 1.35);
    ...
    TH2D *hEcal_vs_dAlpha_T_L_pFDpCD =
        new TH2D("E_{cal} vs. #delta#alpha_{T,L} (All Int., pFDpCD)", "E_{cal} vs. #delta#alpha_{T,L} (All Int., pFDpCD);#delta#alpha_{T,L} [Deg];E_{cal} [GeV];", numTH2Dbins_E_cal_Plots, 0,
    ...
    TH2D *hEcal_vs_Theta_e_nFDpCD = new TH2D("E_{cal} vs. #theta_{e} (All Int., nFDpCD)", "E_{cal} vs. #theta_{e} (All Int., nFDpCD);#theta_{e} [Deg];E_{cal} [GeV];",
                                             numTH2Dbins_E_cal_Plots, Theta_lboundary_FD, Theta_uboundary_FD, numTH2Dbins_E_cal_Plots, 0, beamE * 1.35);
    TH2D *hEcal_vs_Phi_e_nFDpCD = new TH2D("E_{cal} vs. #phi_{e} (All Int., nFDpCD)", "E_{cal} vs. #phi_{e} (All Int., nFDpCD);#phi_{e} [Deg];E_{cal} [GeV];", numTH2Dbins_E_cal_Plots,
                                           Phi_lboundary, Phi_uboundary, numTH2Dbins_E_cal_Plots, 0, beamE * 1.35);
    TH2D *hEcal_vs_Theta_e_test_nFDpCD =
        new TH2D("E_{cal} vs. #theta_{e} for E_{cal}>E_{beam} (All Int., nFDpCD)", "E_{cal} vs. #theta_{e} for E_{cal}>E_{beam} (All Int., nFDpCD);#theta_{e} [Deg];E_{cal} [GeV];",
                 numTH2Dbins_E_cal_Plots, Theta_lboundary_FD, Theta_uboundary_FD, numTH2Dbins_E_cal_Plots, 0, beamE * 1.35);
    ...
    TH2D *hEcal_vs_Theta_nFD_test_nFDpCD =
        new TH2D("E_{cal} vs. #theta_{nFD} for E_{cal}>E_{beam} (All Int., nFDpCD)", "E_{cal} vs. #theta_{nFD} for E_{cal}>E_{beam} (All Int., nFDpCD);#theta_{nFD} [Deg];E_{cal} [GeV];",
                 numTH2Dbins_E_cal_Plots, Theta_lboundary_FD, Theta_uboundary_FD, numTH2Dbins_E_cal_Plots, 0, beamE * 1.35);
    ...
    TH2D *hEcal_vs_Theta_pCD_test_nFDpCD =
        new TH2D("E_{cal} vs. #theta_{pCD} for E_{cal}>E_{beam} (All Int., nFDpCD)", "E_{cal} vs. #theta_{pCD} for E_{cal}>E_{beam} (All Int., nFDpCD);#theta_{pCD} [Deg];E_{cal} [GeV];",
                 numTH2Dbins_E_cal_Plots, Theta_lboundary_CD, Theta_uboundary_CD, numTH2Dbins_E_cal_Plots, 0, beamE * 1.35);
    ...
    TH2D *hEcal_vs_dAlpha_T_L_nFDpCD =
        new TH2D("E_{cal} vs. #delta#alpha_{T,L} (All Int., nFDpCD)", "E_{cal} vs. #delta#alpha_{T,L} (All Int., nFDpCD);#delta#alpha_{T,L} [Deg];E_{cal} [GeV];", numTH2Dbins_E_cal_Plots, 0,
                 180, numTH2Dbins_E_cal_Plots, 0, beamE * 1.35);
    ...
    hPlot1D hP_nFD_truth_1e_cut_FD_ZOOMIN =
        hPlot1D("1e cut", "FD", "TL FD neutrons momentum - ZOOMIN", "FD neutrons momentum P^{truth}_{n} - ZOOMIN", "P^{truth}_{n} [GeV/c]",
                directories.Eff_and_ACorr_Directory_map["Momentum_th_TL_1e_cut_Directory"], "03b_P_nFD_truth_1e_cut_FD_ZOOMIN", 0, 1, numTH1Dbins_Mom_eff_Plots);  // all nFD!
    ...
    hPlot1D hTheta_pip_AC_truth_1e_cut = hPlot1D("1e cut", "", "TL #theta^{truth}_{#pi^{+}} AC", "#theta^{truth}_{#pi^{+}} of Outgoing #pi^{+} AC", "#theta^{truth}_{#pi^{+}} [Deg]",
                                                 ...
                                                 Theta_uboundary_FD, numTH1Dbins_Ang_eff_Plots);
    hPlot1D hTheta_pip_BC_truth_1e_cut = hPlot1D("1e cut", "", "TL #theta^{truth}_{#pi^{+}} BC", "#theta^{truth}_{#pi^{+}} of Outgoing #pi^{+} BC", "#theta^{truth}_{#pi^{+}} [Deg]",
    ...
    hPlot1D hTheta_pim_AC_truth_1e_cut = hPlot1D("1e cut", "", "TL #theta^{truth}_{#pi^{-}} AC", "#theta^{truth}_{#pi^{-}} of Outgoing #pi^{-} AC", "#theta^{truth}_{#pi^{-}} [Deg]",
                                                 ...
                                                 Theta_uboundary_FD, numTH1Dbins_Ang_eff_Plots);
    hPlot1D hTheta_pim_BC_truth_1e_cut = hPlot1D("1e cut", "", "TL #theta^{truth}_{#pi^{-}} BC", "#theta^{truth}_{#pi^{-}} of Outgoing #pi^{-} BC", "#theta^{truth}_{#pi^{-}} [Deg]",
    ...
    hPlot1D hTheta_pi0_AC_truth_1e_cut = hPlot1D("1e cut", "", "TL #theta^{truth}_{#pi^{0}} AC", "#theta^{truth}_{#pi^{0}} of Outgoing #pi^{0} AC", "#theta^{truth}_{#pi^{0}} [Deg]",
                                                 ...
                                                 Theta_uboundary_FD, numTH1Dbins_Ang_eff_Plots);
    hPlot1D hTheta_pi0_BC_truth_1e_cut = hPlot1D("1e cut", "", "TL #theta^{truth}_{#pi^{0}} BC", "#theta^{truth}_{#pi^{0}} of Outgoing #pi^{0} BC", "#theta^{truth}_{#pi^{0}} [Deg]",
    ...
    hPlot1D hTheta_ph_AC_truth_1e_cut = hPlot1D("1e cut", "", "TL #theta^{truth}_{#gamma} AC", "#theta^{truth}_{#gamma} of Outgoing #gamma AC", "#theta^{truth}_{#gamma} [Deg]",
                                                ...
                                                Theta_uboundary_FD, numTH1Dbins_Ang_eff_Plots);
    hPlot1D hTheta_ph_BC_truth_1e_cut = hPlot1D("1e cut", "", "TL #theta^{truth}_{#gamma} BC", "#theta^{truth}_{#gamma} of Outgoing #gamma BC", "#theta^{truth}_{#gamma} [Deg]",
    ...
    hPlot1D hPhi_e_AC_truth_1e_cut =
        hPlot1D("1e cut", "", "TL #phi^{truth}_{e} AC", "#phi^{truth}_{e} of Outgoing Electron AC", "#phi^{truth}_{e} [Deg]",
    ...
    hPlot1D hPhi_e_BC_truth_1e_cut =
        hPlot1D("1e cut", "", "TL #phi^{truth}_{e} BC", "#phi^{truth}_{e} of Outgoing Electron BC", "#phi^{truth}_{e} [Deg]",
    ...
    hPlot1D hPhi_n_AC_truth_1e_cut =
        hPlot1D("1e cut", "", "TL #phi^{truth}_{n} AC", "#phi^{truth}_{n} of Outgoing Neutron AC", "#phi^{truth}_{n} [Deg]",
    ...
    hPlot1D hPhi_n_BC_truth_1e_cut =
        hPlot1D("1e cut", "", "TL #phi^{truth}_{n} BC", "#phi^{truth}_{n} of Outgoing Neutron BC", "#phi^{truth}_{n} [Deg]",
    ...
    hPlot1D hPhi_p_AC_truth_1e_cut =
        hPlot1D("1e cut", "", "TL #phi^{truth}_{p} AC", "#phi^{truth}_{n} of Outgoing Proton AC", "#phi^{truth}_{p} [Deg]",
    ...
    hPlot1D hPhi_p_BC_truth_1e_cut =
        hPlot1D("1e cut", "", "TL #phi^{truth}_{p} BC", "#phi^{truth}_{n} of Outgoing Proton BC", "#phi^{truth}_{p} [Deg]",
    ...
    hPlot1D hPhi_pip_AC_truth_1e_cut =
        hPlot1D("1e cut", "", "TL #phi^{truth}_{#pi^{+}} AC", "#phi^{truth}_{#pi^{+}} of Outgoing #pi^{+} AC", "#phi^{truth}_{#pi^{+}} [Deg]",
    ...
    hPlot1D hPhi_pip_BC_truth_1e_cut =
        hPlot1D("1e cut", "", "TL #phi^{truth}_{#pi^{+}} BC", "#phi^{truth}_{#pi^{+}} of Outgoing #pi^{+} BC", "#phi^{truth}_{#pi^{+}} [Deg]",
    ...
    hPlot1D hPhi_pi0_AC_truth_1e_cut =
        hPlot1D("1e cut", "", "TL #phi^{truth}_{#pi^{0}} AC", "#phi^{truth}_{#pi^{0}} of Outgoing #pi^{0} AC", "#phi^{truth}_{#pi^{0}} [Deg]",
    ...
    hPlot1D hPhi_pi0_BC_truth_1e_cut =
        hPlot1D("1e cut", "", "TL #phi^{truth}_{#pi^{0}} BC", "#phi^{truth}_{#pi^{0}} of Outgoing #pi^{0} BC", "#phi^{truth}_{#pi^{0}} [Deg]",
    ...
    hPlot1D hPhi_ph_AC_truth_1e_cut =
        hPlot1D("1e cut", "", "TL #phi^{truth}_{#gamma} AC", "#phi^{truth}_{#gamma} of Outgoing #gamma AC", "#phi^{truth}_{#gamma} [Deg]",
    ...
    hPlot1D hPhi_ph_BC_truth_1e_cut =
        hPlot1D("1e cut", "", "TL #phi^{truth}_{#gamma} BC", "#phi^{truth}_{#gamma} of Outgoing #gamma BC", "#phi^{truth}_{#gamma} [Deg]",
    ...
    hPlot2D hTheta_nFD_vs_Phi_nFD_truth_1e_cut =
        hPlot2D("1e cut", "FD", "TL #theta_{nFD} vs. #phi_{nFD}", "TL #theta_{nFD} vs. #phi_{nFD}", "#phi_{nFD} [Deg]", "#theta_{nFD} [Deg]",
    ...
    hPlot2D hTheta_pFD_vs_Phi_pFD_truth_1e_cut =
        hPlot2D("1e cut", "FD", "TL #theta_{pFD} vs. #phi_{pFD}", "TL #theta_{pFD} vs. #phi_{pFD}", "#phi_{pFD} [Deg]", "#theta_{pFD} [Deg]",
    ...
    hPlot1D hP_pFD_AC_truth_1p =
        hPlot1D("1p", "FD", "FD TL Proton momentum AC", "FD Proton momentum P^{truth}_{p} AC", "P^{truth}_{p} [GeV/c]",
                directories.Eff_and_ACorr_Directory_map["Mom_Eff_and_ACorr_1p_Directory"], "03b_P_pFD_AC_truth_1p", Momentum_lboundary, Momentum_uboundary, numTH1Dbins_Mom_eff_Plots);
    ...
    hPlot1D hTheta_e_AC_truth_1p =
        hPlot1D("1p", "", "TL #theta^{truth}_{e} AC", "#theta^{truth}_{e} of Outgoing Electron AC", "#theta^{truth}_{e} [Deg]",
    ...
    hPlot1D hTheta_e_BC_truth_1p =
        hPlot1D("1p", "", "TL #theta^{truth}_{e} BC", "#theta^{truth}_{e} of Outgoing Electron BC", "#theta^{truth}_{e} [Deg]",
    ...
    hPlot1D hTheta_n_AC_truth_1p =
        hPlot1D("1p", "", "TL #theta^{truth}_{n} AC", "#theta^{truth}_{n} of Outgoing Neutron AC", "#theta^{truth}_{n} [Deg]",
    ...
    hPlot1D hTheta_n_BC_truth_1p =
        hPlot1D("1p", "", "TL #theta^{truth}_{n} BC", "#theta^{truth}_{n} of Outgoing Neutron BC", "#theta^{truth}_{n} [Deg]",
    ...
    hPlot1D hTheta_p_AC_truth_1p =
        hPlot1D("1p", "", "TL #theta^{truth}_{p} AC", "#theta^{truth}_{p} of Outgoing Proton AC", "#theta^{truth}_{p} [Deg]",
    ...
    hPlot1D hTheta_p_BC_truth_1p =
        hPlot1D("1p", "", "TL #theta^{truth}_{p} BC", "#theta^{truth}_{p} of Outgoing Proton BC", "#theta^{truth}_{p} [Deg]",
    ...
    hPlot1D hTheta_pFD_AC_truth_1p =
        hPlot1D("1p", "FD", "FD TL #theta^{truth}_{p} AC", "#theta^{truth}_{p} of Outgoing FD Proton AC", "#theta^{truth}_{p} [Deg]",
    ...
    hPlot1D hTheta_pFD_BC_truth_1p =
        hPlot1D("1p", "FD", "FD TL #theta^{truth}_{p} BC", "#theta^{truth}_{p} of Outgoing FD Proton BC", "#theta^{truth}_{p} [Deg]",
    ...
    hPlot1D hTheta_pi0_AC_truth_1p =
        hPlot1D("1p", "", "TL #theta^{truth}_{#pi^{0}} AC", "#theta^{truth}_{#pi^{0}} of Outgoing #pi^{0} AC", "#theta^{truth}_{#pi^{0}} [Deg]",
    ...
    hPlot1D hTheta_pi0_BC_truth_1p =
        hPlot1D("1p", "", "TL #theta^{truth}_{#pi^{0}} BC", "#theta^{truth}_{#pi^{0}} of Outgoing #pi^{0} BC", "#theta^{truth}_{#pi^{0}} [Deg]",
    ...
    hPlot1D hTheta_ph_AC_truth_1p =
        hPlot1D("1p", "", "TL #theta^{truth}_{#gamma} AC", "#theta^{truth}_{#gamma} of Outgoing #gamma AC", "#theta^{truth}_{#gamma} [Deg]",
    ...
    hPlot1D hTheta_ph_BC_truth_1p =
        hPlot1D("1p", "", "TL #theta^{truth}_{#gamma} BC", "#theta^{truth}_{#gamma} of Outgoing #gamma BC", "#theta^{truth}_{#gamma} [Deg]",
    ...
    hPlot1D hTheta_ph_AC_truth_1p_FD = hPlot1D("1p", "FD", "FD TL #theta^{truth}_{#gamma} AC", "#theta^{truth}_{#gamma} of FD Outgoing #gamma AC", "#theta^{truth}_{#gamma} [Deg]",
                                               directories.Eff_and_ACorr_Directory_map["Theta_Eff_and_ACorr_1p_Directory"], "07b_Theta_ph_AC_truth_1p_FD", Theta_lboundary_FD,
                                               Theta_uboundary_FD, numTH1Dbins_Ang_eff_Plots);
    hPlot1D hTheta_ph_BC_truth_1p_FD = hPlot1D("1p", "FD", "FD TL #theta^{truth}_{#gamma} BC", "#theta^{truth}_{#gamma} of FD Outgoing #gamma BC", "#theta^{truth}_{#gamma} [Deg]",
    ...
    hPlot1D hPhi_e_AC_truth_1p =
        hPlot1D("1p", "", "TL #phi^{truth}_{e} AC", "#phi^{truth}_{e} of Outgoing Electron AC", "#phi^{truth}_{e} [Deg]",
    ...
    hPlot1D hPhi_e_BC_truth_1p =
        hPlot1D("1p", "", "TL #phi^{truth}_{e} BC", "#phi^{truth}_{e} of Outgoing Electron BC", "#phi^{truth}_{e} [Deg]",
    ...
    hPlot1D hPhi_n_AC_truth_1p =
        hPlot1D("1p", "", "TL #phi^{truth}_{n} AC", "#phi^{truth}_{n} of Outgoing Neutron AC", "#phi^{truth}_{n} [Deg]",
    ...
    hPlot1D hPhi_n_BC_truth_1p =
        hPlot1D("1p", "", "TL #phi^{truth}_{n} BC", "#phi^{truth}_{n} of Outgoing Neutron BC", "#phi^{truth}_{n} [Deg]",
    ...
    hPlot1D hPhi_p_AC_truth_1p =
        hPlot1D("1p", "", "TL #phi^{truth}_{p} AC", "#phi^{truth}_{n} of Outgoing Proton AC", "#phi^{truth}_{p} [Deg]",
    ...
    hPlot1D hPhi_p_BC_truth_1p =
        hPlot1D("1p", "", "TL #phi^{truth}_{p} BC", "#phi^{truth}_{n} of Outgoing Proton BC", "#phi^{truth}_{p} [Deg]",
    ...
    hPlot1D hPhi_pFD_AC_truth_1p =
        hPlot1D("1p", "FD", "FD TL #phi^{truth}_{p} AC", "#phi^{truth}_{n} of FD Outgoing Proton AC", "#phi^{truth}_{p} [Deg]",
    ...
    hPlot1D hPhi_pFD_BC_truth_1p =
        hPlot1D("1p", "FD", "FD TL #phi^{truth}_{p} BC", "#phi^{truth}_{n} of FD Outgoing Proton BC", "#phi^{truth}_{p} [Deg]",
    ...
    hPlot1D hPhi_pip_AC_truth_1p =
        hPlot1D("1p", "", "TL #phi^{truth}_{#pi^{+}} AC", "#phi^{truth}_{#pi^{+}} of Outgoing #pi^{+} AC", "#phi^{truth}_{#pi^{+}} [Deg]",
    ...
    hPlot1D hPhi_pip_BC_truth_1p =
        hPlot1D("1p", "", "TL #phi^{truth}_{#pi^{+}} BC", "#phi^{truth}_{#pi^{+}} of Outgoing #pi^{+} BC", "#phi^{truth}_{#pi^{+}} [Deg]",
    ...
    hPlot1D hPhi_pi0_AC_truth_1p =
        hPlot1D("1p", "", "TL #phi^{truth}_{#pi^{0}} AC", "#phi^{truth}_{#pi^{0}} of Outgoing #pi^{0} AC", "#phi^{truth}_{#pi^{0}} [Deg]",
    ...
    hPlot1D hPhi_pi0_BC_truth_1p =
        hPlot1D("1p", "", "TL #phi^{truth}_{#pi^{0}} BC", "#phi^{truth}_{#pi^{0}} of Outgoing #pi^{0} BC", "#phi^{truth}_{#pi^{0}} [Deg]",
    ...
    hPlot1D hPhi_ph_AC_truth_1p =
        hPlot1D("1p", "", "TL #phi^{truth}_{#gamma} AC", "#phi^{truth}_{#gamma} of Outgoing #gamma AC", "#phi^{truth}_{#gamma} [Deg]",
    ...
    hPlot1D hPhi_ph_BC_truth_1p =
        hPlot1D("1p", "", "TL #phi^{truth}_{#gamma} BC", "#phi^{truth}_{#gamma} of Outgoing #gamma BC", "#phi^{truth}_{#gamma} [Deg]",
    ...
    hPlot1D hPhi_ph_AC_truth_1p_FD =
        hPlot1D("1p", "FD", "FD TL #phi^{truth}_{#gamma} AC", "#phi^{truth}_{#gamma} of FD Outgoing #gamma AC", "#phi^{truth}_{#gamma} [Deg]",
    ...
    hPlot1D hPhi_ph_BC_truth_1p_FD =
        hPlot1D("1p", "FD", "FD TL #phi^{truth}_{#gamma} BC", "#phi^{truth}_{#gamma} of FD Outgoing #gamma BC", "#phi^{truth}_{#gamma} [Deg]",
    ...
    hPlot2D hTheta_pFD_vs_Phi_pFD_1p_BEC = hPlot2D("1p", "FD", "#theta_{pFD} vs. #phi_{pFD} BEC", "TL #theta_{pFD} vs. #phi_{pFD} BEC", "#phi_{pFD} [Deg]", "#theta_{pFD} [Deg]",
    ...
    hPlot2D hTheta_pFD_vs_Phi_pFD_1p_AEC = hPlot2D("1p", "FD", "#theta_{pFD} vs. #phi_{pFD} AEC", "TL #theta_{pFD} vs. #phi_{pFD} AEC", "#phi_{pFD} [Deg]", "#theta_{pFD} [Deg]",
    ...
    hPlot1D hP_nFD_AC_truth_1n =
        hPlot1D("1n", "FD", "FD TL Neutron momentum AC", "FD Neutron momentum P^{truth}_{n} AC", "P^{truth}_{n} [GeV/c]",
                directories.Eff_and_ACorr_Directory_map["Mom_Eff_and_ACorr_1n_Directory"], "02b_P_nFD_AC_truth_1n", Momentum_lboundary, Momentum_uboundary, numTH1Dbins_Mom_eff_Plots);
    ...
    hPlot1D hTheta_e_AC_truth_1n =
        hPlot1D("1n", "", "TL #theta^{truth}_{e} AC", "#theta^{truth}_{e} of Outgoing Electron AC", "#theta^{truth}_{e} [Deg]",
    ...
    hPlot1D hTheta_e_BC_truth_1n =
        hPlot1D("1n", "", "TL #theta^{truth}_{e} BC", "#theta^{truth}_{e} of Outgoing Electron BC", "#theta^{truth}_{e} [Deg]",
    ...
    hPlot1D hTheta_n_AC_truth_1n =
        hPlot1D("1n", "", "TL #theta^{truth}_{n} AC", "#theta^{truth}_{n} of Outgoing Neutron AC", "#theta^{truth}_{n} [Deg]",
    ...
    hPlot1D hTheta_n_BC_truth_1n =
        hPlot1D("1n", "", "TL #theta^{truth}_{n} BC", "#theta^{truth}_{n} of Outgoing Neutron BC", "#theta^{truth}_{n} [Deg]",
    ...
    hPlot1D hTheta_nFD_AC_truth_1n =
        hPlot1D("1n", "FD", "FD TL #theta^{truth}_{n} AC", "#theta^{truth}_{n} of Outgoing FD Neutron AC", "#theta^{truth}_{n} [Deg]",
    ...
    hPlot1D hTheta_nFD_BC_truth_1n =
        hPlot1D("1n", "FD", "FD TL #theta^{truth}_{n} BC", "#theta^{truth}_{n} of Outgoing FD Neutron BC", "#theta^{truth}_{n} [Deg]",
    ...
    hPlot1D hTheta_p_AC_truth_1n =
        hPlot1D("1n", "", "TL #theta^{truth}_{p} AC", "#theta^{truth}_{p} of Outgoing Proton AC", "#theta^{truth}_{p} [Deg]",
    ...
    hPlot1D hTheta_p_BC_truth_1n =
        hPlot1D("1n", "", "TL #theta^{truth}_{p} BC", "#theta^{truth}_{p} of Outgoing Proton BC", "#theta^{truth}_{p} [Deg]",
    ...
    hPlot1D hTheta_p_AC_truth_1n_undet =
        hPlot1D("1n", "undet", "TL undet #theta^{truth}_{p} AC", "undet #theta^{truth}_{p} of Outgoing Proton AC", "#theta^{truth}_{p} [Deg]",
    ...
    hPlot1D hTheta_p_BC_truth_1n_undet =
        hPlot1D("1n", "undet", "TL undet #theta^{truth}_{p} BC", "undet #theta^{truth}_{p} of Outgoing Proton BC", "#theta^{truth}_{p} [Deg]",
    ...
    hPlot1D hTheta_pip_BC_truth_1n = hPlot1D("1n", "", "TL #theta^{truth}_{#pi^{+}} BC", "#theta^{truth}_{#pi^{+}} of Outgoing #pi^{+} BC", "#theta^{truth}_{#pi^{+}} [Deg]",
                                             ...
                                             Theta_uboundary_FD, numTH1Dbins_Ang_eff_Plots);
    hPlot1D hTheta_pip_AC_truth_1n_FD = hPlot1D("1n", "FD", "TL FD #theta^{truth}_{#pi^{+}} AC", "FD #theta^{truth}_{#pi^{+}} of Outgoing #pi^{+} AC", "#theta^{truth}_{#pi^{+}} [Deg]",
                                                ...
                                                Theta_uboundary_FD, numTH1Dbins_Ang_eff_Plots);
    hPlot1D hTheta_pip_BC_truth_1n_FD = hPlot1D("1n", "FD", "TL FD #theta^{truth}_{#pi^{+}} BC", "FD #theta^{truth}_{#pi^{+}} of Outgoing #pi^{+} BC", "#theta^{truth}_{#pi^{+}} [Deg]",
                                                ...
                                                Theta_uboundary_FD, numTH1Dbins_Ang_eff_Plots);
    hPlot1D hTheta_pip_AC_truth_1n_CD = hPlot1D("1n", "CD", "TL CD #theta^{truth}_{#pi^{+}} AC", "CD #theta^{truth}_{#pi^{+}} of Outgoing #pi^{+} AC", "#theta^{truth}_{#pi^{+}} [Deg]",
                                                ...
                                                Theta_uboundary_CD, numTH1Dbins_Ang_eff_Plots);
    hPlot1D hTheta_pip_BC_truth_1n_CD = hPlot1D("1n", "CD", "TL CD #theta^{truth}_{#pi^{+}} BC", "CD #theta^{truth}_{#pi^{+}} of Outgoing #pi^{+} BC", "#theta^{truth}_{#pi^{+}} [Deg]",
    ...
    hPlot1D hTheta_pip_AC_truth_1n_undet =
        hPlot1D("1n", "undet", "TL undet #theta^{truth}_{#pi^{+}} AC", "undet #theta^{truth}_{#pi^{+}} of Outgoing #pi^{+} AC", "#theta^{truth}_{#pi^{+}} [Deg]",
    ...
    hPlot1D hTheta_pip_BC_truth_1n_undet =
        hPlot1D("1n", "undet", "TL undet #theta^{truth}_{#pi^{+}} BC", "undet #theta^{truth}_{#pi^{+}} of Outgoing #pi^{+} BC", "#theta^{truth}_{#pi^{+}} [Deg]",
    ...
    hPlot1D hTheta_pim_BC_truth_1n = hPlot1D("1n", "", "TL #theta^{truth}_{#pi^{-}} BC", "#theta^{truth}_{#pi^{-}} of Outgoing #pi^{-} BC", "#theta^{truth}_{#pi^{-}} [Deg]",
                                             ...
                                             Theta_uboundary_FD, numTH1Dbins_Ang_eff_Plots);
    hPlot1D hTheta_pim_AC_truth_1n_FD = hPlot1D("1n", "FD", "TL FD #theta^{truth}_{#pi^{-}} AC", "FD #theta^{truth}_{#pi^{-}} of Outgoing #pi^{-} AC", "#theta^{truth}_{#pi^{-}} [Deg]",
                                                ...
                                                Theta_uboundary_FD, numTH1Dbins_Ang_eff_Plots);
    hPlot1D hTheta_pim_BC_truth_1n_FD = hPlot1D("1n", "FD", "TL FD #theta^{truth}_{#pi^{-}} BC", "FD #theta^{truth}_{#pi^{-}} of Outgoing #pi^{-} BC", "#theta^{truth}_{#pi^{-}} [Deg]",
                                                ...
                                                Theta_uboundary_FD, numTH1Dbins_Ang_eff_Plots);
    hPlot1D hTheta_pim_AC_truth_1n_CD = hPlot1D("1n", "CD", "TL CD #theta^{truth}_{#pi^{-}} AC", "CD #theta^{truth}_{#pi^{-}} of Outgoing #pi^{-} AC", "#theta^{truth}_{#pi^{-}} [Deg]",
                                                ...
                                                Theta_uboundary_CD, numTH1Dbins_Ang_eff_Plots);
    hPlot1D hTheta_pim_BC_truth_1n_CD = hPlot1D("1n", "CD", "TL CD #theta^{truth}_{#pi^{-}} BC", "CD #theta^{truth}_{#pi^{-}} of Outgoing #pi^{-} BC", "#theta^{truth}_{#pi^{-}} [Deg]",
    ...
    hPlot1D hTheta_pi0_AC_truth_1n =
        hPlot1D("1n", "", "TL #theta^{truth}_{#pi^{0}} AC", "#theta^{truth}_{#pi^{0}} of Outgoing #pi^{0} AC", "#theta^{truth}_{#pi^{0}} [Deg]",
    ...
    hPlot1D hTheta_pi0_BC_truth_1n =
        hPlot1D("1n", "", "TL #theta^{truth}_{#pi^{0}} BC", "#theta^{truth}_{#pi^{0}} of Outgoing #pi^{0} BC", "#theta^{truth}_{#pi^{0}} [Deg]",
    ...
    hPlot1D hTheta_ph_AC_truth_1n =
        hPlot1D("1n", "", "TL #theta^{truth}_{#gamma} AC", "#theta^{truth}_{#gamma} of Outgoing #gamma AC", "#theta^{truth}_{#gamma} [Deg]",
    ...
    hPlot1D hTheta_ph_BC_truth_1n =
        hPlot1D("1n", "", "TL #theta^{truth}_{#gamma} BC", "#theta^{truth}_{#gamma} of Outgoing #gamma BC", "#theta^{truth}_{#gamma} [Deg]",
    ...
    hPlot1D hTheta_ph_AC_truth_1n_FD = hPlot1D("1n", "FD", "FD TL #theta^{truth}_{#gamma} AC", "#theta^{truth}_{#gamma} of FD Outgoing #gamma AC", "#theta^{truth}_{#gamma} [Deg]",
                                               directories.Eff_and_ACorr_Directory_map["Theta_Eff_and_ACorr_1n_Directory"], "07b_Theta_ph_AC_truth_1n_FD", Theta_lboundary_FD,
                                               Theta_uboundary_FD, numTH1Dbins_Ang_eff_Plots);
    hPlot1D hTheta_ph_BC_truth_1n_FD = hPlot1D("1n", "FD", "FD TL #theta^{truth}_{#gamma} BC", "#theta^{truth}_{#gamma} of FD Outgoing #gamma BC", "#theta^{truth}_{#gamma} [Deg]",
    ...
    hPlot1D hPhi_e_AC_truth_1n =
        hPlot1D("1n", "", "TL #phi^{truth}_{e} AC", "#phi^{truth}_{e} of Outgoing Electron AC", "#phi^{truth}_{e} [Deg]",
    ...
    hPlot1D hPhi_e_BC_truth_1n =
        hPlot1D("1n", "", "TL #phi^{truth}_{e} BC", "#phi^{truth}_{e} of Outgoing Electron BC", "#phi^{truth}_{e} [Deg]",
    ...
    hPlot1D hPhi_n_AC_truth_1n =
        hPlot1D("1n", "", "TL #phi^{truth}_{n} AC", "#phi^{truth}_{n} of Outgoing Neutron AC", "#phi^{truth}_{n} [Deg]",
    ...
    hPlot1D hPhi_n_BC_truth_1n =
        hPlot1D("1n", "", "TL #phi^{truth}_{n} BC", "#phi^{truth}_{n} of Outgoing Neutron BC", "#phi^{truth}_{n} [Deg]",
    ...
    hPlot1D hPhi_nFD_AC_truth_1n =
        hPlot1D("1n", "FD", "FD TL #phi^{truth}_{n} AC", "#phi^{truth}_{n} of Outgoing FD Neutron AC", "#phi^{truth}_{n} [Deg]",
    ...
    hPlot1D hPhi_nFD_BC_truth_1n =
        hPlot1D("1n", "FD", "FD TL #phi^{truth}_{n} BC", "#phi^{truth}_{n} of Outgoing FD Neutron BC", "#phi^{truth}_{n} [Deg]",
    ...
    hPlot1D hPhi_p_AC_truth_1n =
        hPlot1D("1n", "", "TL #phi^{truth}_{p} AC", "#phi^{truth}_{n} of Outgoing Proton AC", "#phi^{truth}_{p} [Deg]",
    ...
    hPlot1D hPhi_p_BC_truth_1n =
        hPlot1D("1n", "", "TL #phi^{truth}_{p} BC", "#phi^{truth}_{n} of Outgoing Proton BC", "#phi^{truth}_{p} [Deg]",
    ...
    hPlot1D hPhi_p_AC_truth_1n_FD =
        hPlot1D("1n", "FD", "TL FD #phi^{truth}_{p} AC", "FD #phi^{truth}_{p} of Outgoing Proton AC", "#phi^{truth}_{p} [Deg]",
    ...
    hPlot1D hPhi_p_BC_truth_1n_FD =
        hPlot1D("1n", "FD", "TL FD #phi^{truth}_{p} BC", "FD #phi^{truth}_{p} of Outgoing Proton BC", "#phi^{truth}_{p} [Deg]",
    ...
    hPlot1D hPhi_p_AC_truth_1n_CD =
        hPlot1D("1n", "CD", "TL CD #phi^{truth}_{p} AC", "CD #phi^{truth}_{p} of Outgoing Proton AC", "#phi^{truth}_{p} [Deg]",
    ...
    hPlot1D hPhi_p_BC_truth_1n_CD =
        hPlot1D("1n", "CD", "TL CD #phi^{truth}_{p} BC", "CD #phi^{truth}_{p} of Outgoing Proton BC", "#phi^{truth}_{p} [Deg]",
    ...
    hPlot1D hPhi_p_AC_truth_1n_undet =
        hPlot1D("1n", "undet", "TL undet #phi^{truth}_{p} AC", "undet #phi^{truth}_{p} of Outgoing Proton AC", "#phi^{truth}_{p} [Deg]",
    ...
    hPlot1D hPhi_p_BC_truth_1n_undet =
        hPlot1D("1n", "undet", "TL undet #phi^{truth}_{p} BC", "undet #phi^{truth}_{p} of Outgoing Proton BC", "#phi^{truth}_{p} [Deg]",
    ...
    hPlot1D hPhi_pip_AC_truth_1n =
        hPlot1D("1n", "", "TL #phi^{truth}_{#pi^{+}} AC", "#phi^{truth}_{#pi^{+}} of Outgoing #pi^{+} AC", "#phi^{truth}_{#pi^{+}} [Deg]",
    ...
    hPlot1D hPhi_pip_BC_truth_1n =
        hPlot1D("1n", "", "TL #phi^{truth}_{#pi^{+}} BC", "#phi^{truth}_{#pi^{+}} of Outgoing #pi^{+} BC", "#phi^{truth}_{#pi^{+}} [Deg]",
    ...
    hPlot1D hPhi_pip_AC_truth_1n_FD =
        hPlot1D("1n", "FD", "TL FD #phi^{truth}_{#pi^{+}} AC", "FD #phi^{truth}_{#pi^{+}} of Outgoing #pi^{+} AC", "#phi^{truth}_{#pi^{+}} [Deg]",
    ...
    hPlot1D hPhi_pip_BC_truth_1n_FD =
        hPlot1D("1n", "FD", "TL FD #phi^{truth}_{#pi^{+}} BC", "FD #phi^{truth}_{#pi^{+}} of Outgoing #pi^{+} BC", "#phi^{truth}_{#pi^{+}} [Deg]",
    ...
    hPlot1D hPhi_pip_AC_truth_1n_CD =
        hPlot1D("1n", "CD", "TL CD #phi^{truth}_{#pi^{+}} AC", "CD #phi^{truth}_{#pi^{+}} of Outgoing #pi^{+} AC", "#phi^{truth}_{#pi^{+}} [Deg]",
    ...
    hPlot1D hPhi_pip_BC_truth_1n_CD =
        hPlot1D("1n", "CD", "TL CD #phi^{truth}_{#pi^{+}} BC", "CD #phi^{truth}_{#pi^{+}} of Outgoing #pi^{+} BC", "#phi^{truth}_{#pi^{+}} [Deg]",
    ...
    hPlot1D hPhi_pip_AC_truth_1n_undet =
        hPlot1D("1n", "undet", "TL undet #phi^{truth}_{#pi^{+}} AC", "undet #phi^{truth}_{#pi^{+}} of Outgoing #pi^{+} AC", "#phi^{truth}_{#pi^{+}} [Deg]",
    ...
    hPlot1D hPhi_pip_BC_truth_1n_undet =
        hPlot1D("1n", "undet", "TL undet #phi^{truth}_{#pi^{+}} BC", "undet #phi^{truth}_{#pi^{+}} of Outgoing #pi^{+} BC", "#phi^{truth}_{#pi^{+}} [Deg]",
    ...
    hPlot1D hPhi_pi0_AC_truth_1n =
        hPlot1D("1n", "", "TL #phi^{truth}_{#pi^{0}} AC", "#phi^{truth}_{#pi^{0}} of Outgoing #pi^{0} AC", "#phi^{truth}_{#pi^{0}} [Deg]",
    ...
    hPlot1D hPhi_pi0_BC_truth_1n =
        hPlot1D("1n", "", "TL #phi^{truth}_{#pi^{0}} BC", "#phi^{truth}_{#pi^{0}} of Outgoing #pi^{0} BC", "#phi^{truth}_{#pi^{0}} [Deg]",
    ...
    hPlot1D hPhi_ph_AC_truth_1n =
        hPlot1D("1n", "", "TL #phi^{truth}_{#gamma} AC", "#phi^{truth}_{#gamma} of Outgoing #gamma AC", "#phi^{truth}_{#gamma} [Deg]",
    ...
    hPlot1D hPhi_ph_BC_truth_1n =
        hPlot1D("1n", "", "TL #phi^{truth}_{#gamma} BC", "#phi^{truth}_{#gamma} of Outgoing #gamma BC", "#phi^{truth}_{#gamma} [Deg]",
    ...
    hPlot1D hPhi_ph_AC_truth_1n_FD =
        hPlot1D("1n", "FD", "FD TL #phi^{truth}_{#gamma} AC", "#phi^{truth}_{#gamma} of FD Outgoing #gamma AC", "#phi^{truth}_{#gamma} [Deg]",
    ...
    hPlot1D hPhi_ph_BC_truth_1n_FD =
        hPlot1D("1n", "FD", "FD TL #phi^{truth}_{#gamma} BC", "#phi^{truth}_{#gamma} of FD Outgoing #gamma BC", "#phi^{truth}_{#gamma} [Deg]",
    ...
    hPlot2D hTheta_nFD_vs_Phi_nFD_1n_BEC = hPlot2D("1n", "FD", "#theta_{nFD} vs. #phi_{nFD} BEC", "TL #theta_{nFD} vs. #phi_{nFD} BEC", "#phi_{nFD} [Deg]", "#theta_{nFD} [Deg]",
                                                   directories.Eff_and_ACorr_Directory_map["Neutron_FD_Hit_map_1n_Directory"], "02a_Theta_nFD_vs_Phi_nFD_BEC_1n", Phi_lboundary,
                                                   Phi_uboundary, Theta_lboundary_FD, Theta_uboundary_FD, numTH2Dbins_Nucleon_Ang_eff_Plots, numTH2Dbins_Nucleon_Ang_eff_Plots);
    hPlot2D hTheta_nFD_vs_Phi_nFD_1n_AEC = hPlot2D("1n", "FD", "#theta_{nFD} vs. #phi_{nFD} AEC", "TL #theta_{nFD} vs. #phi_{nFD} AEC", "#phi_{nFD} [Deg]", "#theta_{nFD} [Deg]",
    ...
    hPlot1D hP_pFD_AC_truth_pFDpCD = hPlot1D("pFDpCD", "FD", "FD TL Proton momentum AC", "FD Proton momentum P^{truth}_{p} AC", "P^{truth}_{p} [GeV/c]",
                                             directories.Eff_and_ACorr_Directory_map["Mom_Eff_and_ACorr_pFDpCD_Directory"], "03b_P_pFD_AC_truth_pFDpCD", Momentum_lboundary,
                                             Momentum_uboundary, numTH1Dbins_Mom_eff_Plots);
    ...
    hPlot1D hTheta_pip_AC_truth_pFDpCD = hPlot1D("pFDpCD", "", "TL #theta^{truth}_{#pi^{+}} AC", "#theta^{truth}_{#pi^{+}} of Outgoing #pi^{+} AC", "#theta^{truth}_{#pi^{+}} [Deg]",
                                                 ...
                                                 Theta_uboundary_FD, numTH1Dbins_Ang_eff_Plots);
    hPlot1D hTheta_pip_BC_truth_pFDpCD = hPlot1D("pFDpCD", "", "TL #theta^{truth}_{#pi^{+}} BC", "#theta^{truth}_{#pi^{+}} of Outgoing #pi^{+} BC", "#theta^{truth}_{#pi^{+}} [Deg]",
    ...
    hPlot1D hTheta_pim_AC_truth_pFDpCD = hPlot1D("pFDpCD", "", "TL #theta^{truth}_{#pi^{-}} AC", "#theta^{truth}_{#pi^{-}} of Outgoing #pi^{-} AC", "#theta^{truth}_{#pi^{-}} [Deg]",
                                                 ...
                                                 Theta_uboundary_FD, numTH1Dbins_Ang_eff_Plots);
    hPlot1D hTheta_pim_BC_truth_pFDpCD = hPlot1D("pFDpCD", "", "TL #theta^{truth}_{#pi^{-}} BC", "#theta^{truth}_{#pi^{-}} of Outgoing #pi^{-} BC", "#theta^{truth}_{#pi^{-}} [Deg]",
    ...
    hPlot1D hTheta_pi0_AC_truth_pFDpCD = hPlot1D("pFDpCD", "", "TL #theta^{truth}_{#pi^{0}} AC", "#theta^{truth}_{#pi^{0}} of Outgoing #pi^{0} AC", "#theta^{truth}_{#pi^{0}} [Deg]",
                                                 ...
                                                 Theta_uboundary_FD, numTH1Dbins_Ang_eff_Plots);
    hPlot1D hTheta_pi0_BC_truth_pFDpCD = hPlot1D("pFDpCD", "", "TL #theta^{truth}_{#pi^{0}} BC", "#theta^{truth}_{#pi^{0}} of Outgoing #pi^{0} BC", "#theta^{truth}_{#pi^{0}} [Deg]",
    ...
    hPlot1D hTheta_ph_AC_truth_pFDpCD = hPlot1D("pFDpCD", "", "TL #theta^{truth}_{#gamma} AC", "#theta^{truth}_{#gamma} of Outgoing #gamma AC", "#theta^{truth}_{#gamma} [Deg]",
                                                ...
                                                Theta_uboundary_FD, numTH1Dbins_Ang_eff_Plots);
    hPlot1D hTheta_ph_BC_truth_pFDpCD = hPlot1D("pFDpCD", "", "TL #theta^{truth}_{#gamma} BC", "#theta^{truth}_{#gamma} of Outgoing #gamma BC", "#theta^{truth}_{#gamma} [Deg]",
                                                ...
                                                Theta_uboundary_FD, numTH1Dbins_Ang_eff_Plots);
    hPlot1D hTheta_ph_AC_truth_pFDpCD_FD = hPlot1D("pFDpCD", "FD", "FD TL #theta^{truth}_{#gamma} AC", "#theta^{truth}_{#gamma} of FD Outgoing #gamma AC", "#theta^{truth}_{#gamma} [Deg]",
                                                   ...
                                                   Theta_uboundary_FD, numTH1Dbins_Ang_eff_Plots);
    hPlot1D hTheta_ph_BC_truth_pFDpCD_FD = hPlot1D("pFDpCD", "FD", "FD TL #theta^{truth}_{#gamma} BC", "#theta^{truth}_{#gamma} of FD Outgoing #gamma BC", "#theta^{truth}_{#gamma} [Deg]",
    ...
    hPlot1D hPhi_e_AC_truth_pFDpCD =
        hPlot1D("pFDpCD", "", "TL #phi^{truth}_{e} AC", "#phi^{truth}_{e} of Outgoing Electron AC", "#phi^{truth}_{e} [Deg]",
    ...
    hPlot1D hPhi_e_BC_truth_pFDpCD =
        hPlot1D("pFDpCD", "", "TL #phi^{truth}_{e} BC", "#phi^{truth}_{e} of Outgoing Electron BC", "#phi^{truth}_{e} [Deg]",
    ...
    hPlot1D hPhi_n_AC_truth_pFDpCD =
        hPlot1D("pFDpCD", "", "TL #phi^{truth}_{n} AC", "#phi^{truth}_{n} of Outgoing Neutron AC", "#phi^{truth}_{n} [Deg]",
    ...
    hPlot1D hPhi_n_BC_truth_pFDpCD =
        hPlot1D("pFDpCD", "", "TL #phi^{truth}_{n} BC", "#phi^{truth}_{n} of Outgoing Neutron BC", "#phi^{truth}_{n} [Deg]",
    ...
    hPlot1D hPhi_p_AC_truth_pFDpCD =
        hPlot1D("pFDpCD", "", "TL #phi^{truth}_{p} AC", "#phi^{truth}_{n} of Outgoing Proton AC", "#phi^{truth}_{p} [Deg]",
    ...
    hPlot1D hPhi_p_BC_truth_pFDpCD =
        hPlot1D("pFDpCD", "", "TL #phi^{truth}_{p} BC", "#phi^{truth}_{n} of Outgoing Proton BC", "#phi^{truth}_{p} [Deg]",
    ...
    hPlot1D hPhi_pFD_AC_truth_pFDpCD =
        hPlot1D("pFDpCD", "FD", "FD TL #phi^{truth}_{p} AC", "#phi^{truth}_{n} of FD Outgoing Proton AC", "#phi^{truth}_{p} [Deg]",
    ...
    hPlot1D hPhi_pFD_BC_truth_pFDpCD =
        hPlot1D("pFDpCD", "FD", "FD TL #phi^{truth}_{p} BC", "#phi^{truth}_{n} of FD Outgoing Proton BC", "#phi^{truth}_{p} [Deg]",
    ...
    hPlot1D hPhi_pCD_AC_truth_pFDpCD =
        hPlot1D("pFDpCD", "CD", "CD TL #phi^{truth}_{p} AC", "#phi^{truth}_{n} of CD Outgoing Proton AC", "#phi^{truth}_{p} [Deg]",
    ...
    hPlot1D hPhi_pCD_BC_truth_pFDpCD =
        hPlot1D("pFDpCD", "CD", "CD TL #phi^{truth}_{p} BC", "#phi^{truth}_{n} of CD Outgoing Proton BC", "#phi^{truth}_{p} [Deg]",
    ...
    hPlot1D hPhi_pip_AC_truth_pFDpCD =
        hPlot1D("pFDpCD", "", "TL #phi^{truth}_{#pi^{+}} AC", "#phi^{truth}_{#pi^{+}} of Outgoing #pi^{+} AC", "#phi^{truth}_{#pi^{+}} [Deg]",
    ...
    hPlot1D hPhi_pip_BC_truth_pFDpCD =
        hPlot1D("pFDpCD", "", "TL #phi^{truth}_{#pi^{+}} BC", "#phi^{truth}_{#pi^{+}} of Outgoing #pi^{+} BC", "#phi^{truth}_{#pi^{+}} [Deg]",
    ...
    hPlot1D hPhi_pi0_AC_truth_pFDpCD =
        hPlot1D("pFDpCD", "", "TL #phi^{truth}_{#pi^{0}} AC", "#phi^{truth}_{#pi^{0}} of Outgoing #pi^{0} AC", "#phi^{truth}_{#pi^{0}} [Deg]",
    ...
    hPlot1D hPhi_pi0_BC_truth_pFDpCD =
        hPlot1D("pFDpCD", "", "TL #phi^{truth}_{#pi^{0}} BC", "#phi^{truth}_{#pi^{0}} of Outgoing #pi^{0} BC", "#phi^{truth}_{#pi^{0}} [Deg]",
    ...
    hPlot1D hPhi_ph_AC_truth_pFDpCD =
        hPlot1D("pFDpCD", "", "TL #phi^{truth}_{#gamma} AC", "#phi^{truth}_{#gamma} of Outgoing #gamma AC", "#phi^{truth}_{#gamma} [Deg]",
    ...
    hPlot1D hPhi_ph_BC_truth_pFDpCD =
        hPlot1D("pFDpCD", "", "TL #phi^{truth}_{#gamma} BC", "#phi^{truth}_{#gamma} of Outgoing #gamma BC", "#phi^{truth}_{#gamma} [Deg]",
    ...
    hPlot1D hPhi_ph_AC_truth_pFDpCD_FD =
        hPlot1D("pFDpCD", "FD", "FD TL #phi^{truth}_{#gamma} AC", "#phi^{truth}_{#gamma} of FD Outgoing #gamma AC", "#phi^{truth}_{#gamma} [Deg]",
    ...
    hPlot1D hPhi_ph_BC_truth_pFDpCD_FD =
        hPlot1D("pFDpCD", "FD", "FD TL #phi^{truth}_{#gamma} BC", "#phi^{truth}_{#gamma} of FD Outgoing #gamma BC", "#phi^{truth}_{#gamma} [Deg]",
    ...
    hPlot2D hTheta_pFD_vs_Phi_pFD_pFDpCD_BEC = hPlot2D("pFDpCD", "FD", "#theta_{pFD} vs. #phi_{pFD} BEC", "TL #theta_{pFD} vs. #phi_{pFD} BEC", "#phi_{pFD} [Deg]", "#theta_{pFD} [Deg]",
                                                       ...
                                                       Phi_uboundary, Theta_lboundary_FD, Theta_uboundary_FD, numTH2Dbins_Nucleon_Ang_eff_Plots, numTH2Dbins_Nucleon_Ang_eff_Plots);
    hPlot2D hTheta_pFD_vs_Phi_pFD_pFDpCD_AEC = hPlot2D("pFDpCD", "FD", "#theta_{pFD} vs. #phi_{pFD} AEC", "TL #theta_{pFD} vs. #phi_{pFD} AEC", "#phi_{pFD} [Deg]", "#theta_{pFD} [Deg]",
    ...
    hPlot2D hTheta_pFD_vs_Phi_pFD_truth_pFDpCD = hPlot2D("pFDpCD", "FD", "TL #theta_{pFD} vs. #phi_{pFD}", "TL #theta_{pFD} vs. #phi_{pFD}", "#phi_{pFD} [Deg]", "#theta_{pFD} [Deg]",
    ...
    hPlot1D hP_nFD_AC_truth_nFDpCD = hPlot1D("nFDpCD", "FD", "FD TL Neutron momentum AC", "FD Neutron momentum P^{truth}_{n} AC", "P^{truth}_{n} [GeV/c]",
                                             directories.Eff_and_ACorr_Directory_map["Mom_Eff_and_ACorr_nFDpCD_Directory"], "02b_P_nFD_AC_truth_nFDpCD", Momentum_lboundary,
                                             Momentum_uboundary, numTH1Dbins_Mom_eff_Plots);
    ...
    hPlot1D hTheta_pip_AC_truth_nFDpCD = hPlot1D("nFDpCD", "", "TL #theta^{truth}_{#pi^{+}} AC", "#theta^{truth}_{#pi^{+}} of Outgoing #pi^{+} AC", "#theta^{truth}_{#pi^{+}} [Deg]",
                                                 ...
                                                 Theta_uboundary_FD, numTH1Dbins_Ang_eff_Plots);
    hPlot1D hTheta_pip_BC_truth_nFDpCD = hPlot1D("nFDpCD", "", "TL #theta^{truth}_{#pi^{+}} BC", "#theta^{truth}_{#pi^{+}} of Outgoing #pi^{+} BC", "#theta^{truth}_{#pi^{+}} [Deg]",
    ...
    hPlot1D hTheta_pim_AC_truth_nFDpCD = hPlot1D("nFDpCD", "", "TL #theta^{truth}_{#pi^{-}} AC", "#theta^{truth}_{#pi^{-}} of Outgoing #pi^{-} AC", "#theta^{truth}_{#pi^{-}} [Deg]",
                                                 ...
                                                 Theta_uboundary_FD, numTH1Dbins_Ang_eff_Plots);
    hPlot1D hTheta_pim_BC_truth_nFDpCD = hPlot1D("nFDpCD", "", "TL #theta^{truth}_{#pi^{-}} BC", "#theta^{truth}_{#pi^{-}} of Outgoing #pi^{-} BC", "#theta^{truth}_{#pi^{-}} [Deg]",
    ...
    hPlot1D hTheta_pi0_AC_truth_nFDpCD = hPlot1D("nFDpCD", "", "TL #theta^{truth}_{#pi^{0}} AC", "#theta^{truth}_{#pi^{0}} of Outgoing #pi^{0} AC", "#theta^{truth}_{#pi^{0}} [Deg]",
                                                 ...
                                                 Theta_uboundary_FD, numTH1Dbins_Ang_eff_Plots);
    hPlot1D hTheta_pi0_BC_truth_nFDpCD = hPlot1D("nFDpCD", "", "TL #theta^{truth}_{#pi^{0}} BC", "#theta^{truth}_{#pi^{0}} of Outgoing #pi^{0} BC", "#theta^{truth}_{#pi^{0}} [Deg]",
    ...
    hPlot1D hTheta_ph_AC_truth_nFDpCD = hPlot1D("nFDpCD", "", "TL #theta^{truth}_{#gamma} AC", "#theta^{truth}_{#gamma} of Outgoing #gamma AC", "#theta^{truth}_{#gamma} [Deg]",
                                                ...
                                                Theta_uboundary_FD, numTH1Dbins_Ang_eff_Plots);
    hPlot1D hTheta_ph_BC_truth_nFDpCD = hPlot1D("nFDpCD", "", "TL #theta^{truth}_{#gamma} BC", "#theta^{truth}_{#gamma} of Outgoing #gamma BC", "#theta^{truth}_{#gamma} [Deg]",
                                                ...
                                                Theta_uboundary_FD, numTH1Dbins_Ang_eff_Plots);
    hPlot1D hTheta_ph_AC_truth_nFDpCD_FD = hPlot1D("nFDpCD", "FD", "FD TL #theta^{truth}_{#gamma} AC", "#theta^{truth}_{#gamma} of FD Outgoing #gamma AC", "#theta^{truth}_{#gamma} [Deg]",
                                                   ...
                                                   Theta_uboundary_FD, numTH1Dbins_Ang_eff_Plots);
    hPlot1D hTheta_ph_BC_truth_nFDpCD_FD = hPlot1D("nFDpCD", "FD", "FD TL #theta^{truth}_{#gamma} BC", "#theta^{truth}_{#gamma} of FD Outgoing #gamma BC", "#theta^{truth}_{#gamma} [Deg]",
    ...
    hPlot1D hPhi_e_AC_truth_nFDpCD =
        hPlot1D("nFDpCD", "", "TL #phi^{truth}_{e} AC", "#phi^{truth}_{e} of Outgoing Electron AC", "#phi^{truth}_{e} [Deg]",
    ...
    hPlot1D hPhi_e_BC_truth_nFDpCD =
        hPlot1D("nFDpCD", "", "TL #phi^{truth}_{e} BC", "#phi^{truth}_{e} of Outgoing Electron BC", "#phi^{truth}_{e} [Deg]",
    ...
    hPlot1D hPhi_n_AC_truth_nFDpCD =
        hPlot1D("nFDpCD", "", "TL #phi^{truth}_{n} AC", "#phi^{truth}_{n} of Outgoing Neutron AC", "#phi^{truth}_{n} [Deg]",
    ...
    hPlot1D hPhi_n_BC_truth_nFDpCD =
        hPlot1D("nFDpCD", "", "TL #phi^{truth}_{n} BC", "#phi^{truth}_{n} of Outgoing Neutron BC", "#phi^{truth}_{n} [Deg]",
    ...
    hPlot1D hPhi_nFD_AC_truth_nFDpCD =
        hPlot1D("nFDpCD", "FD", "FD TL #phi^{truth}_{n} AC", "#phi^{truth}_{n} of Outgoing FD Neutron AC", "#phi^{truth}_{n} [Deg]",
    ...
    hPlot1D hPhi_nFD_BC_truth_nFDpCD =
        hPlot1D("nFDpCD", "FD", "FD TL #phi^{truth}_{n} BC", "#phi^{truth}_{n} of Outgoing FD Neutron AC", "#phi^{truth}_{n} [Deg]",
    ...
    hPlot1D hPhi_p_AC_truth_nFDpCD =
        hPlot1D("nFDpCD", "", "TL #phi^{truth}_{p} AC", "#phi^{truth}_{n} of Outgoing Proton AC", "#phi^{truth}_{p} [Deg]",
    ...
    hPlot1D hPhi_p_BC_truth_nFDpCD =
        hPlot1D("nFDpCD", "", "TL #phi^{truth}_{p} BC", "#phi^{truth}_{n} of Outgoing Proton BC", "#phi^{truth}_{p} [Deg]",
    ...
    hPlot1D hPhi_pFD_AC_truth_nFDpCD =
        hPlot1D("nFDpCD", "FD", "FD TL #phi^{truth}_{p} AC", "#phi^{truth}_{p} of Outgoing FD Proton AC", "#phi^{truth}_{p} [Deg]",
    ...
    hPlot1D hPhi_pFD_BC_truth_nFDpCD =
        hPlot1D("nFDpCD", "FD", "FD TL #phi^{truth}_{p} BC", "#phi^{truth}_{p} of Outgoing FD Proton BC", "#phi^{truth}_{p} [Deg]",
    ...
    hPlot1D hPhi_pCD_AC_truth_nFDpCD =
        hPlot1D("nFDpCD", "CD", "CD TL #phi^{truth}_{p} AC", "#phi^{truth}_{p} of Outgoing CD Proton AC", "#phi^{truth}_{p} [Deg]",
    ...
    hPlot1D hPhi_pCD_BC_truth_nFDpCD =
        hPlot1D("nFDpCD", "CD", "CD TL #phi^{truth}_{p} BC", "#phi^{truth}_{p} of Outgoing CD Proton BC", "#phi^{truth}_{p} [Deg]",
    ...
    hPlot1D hPhi_pip_AC_truth_nFDpCD =
        hPlot1D("nFDpCD", "", "TL #phi^{truth}_{#pi^{+}} AC", "#phi^{truth}_{#pi^{+}} of Outgoing #pi^{+} AC", "#phi^{truth}_{#pi^{+}} [Deg]",
    ...
    hPlot1D hPhi_pip_BC_truth_nFDpCD =
        hPlot1D("nFDpCD", "", "TL #phi^{truth}_{#pi^{+}} BC", "#phi^{truth}_{#pi^{+}} of Outgoing #pi^{+} BC", "#phi^{truth}_{#pi^{+}} [Deg]",
    ...
    hPlot1D hPhi_pi0_AC_truth_nFDpCD =
        hPlot1D("nFDpCD", "", "TL #phi^{truth}_{#pi^{0}} AC", "#phi^{truth}_{#pi^{0}} of Outgoing #pi^{0} AC", "#phi^{truth}_{#pi^{0}} [Deg]",
    ...
    hPlot1D hPhi_pi0_BC_truth_nFDpCD =
        hPlot1D("nFDpCD", "", "TL #phi^{truth}_{#pi^{0}} BC", "#phi^{truth}_{#pi^{0}} of Outgoing #pi^{0} BC", "#phi^{truth}_{#pi^{0}} [Deg]",
    ...
    hPlot1D hPhi_ph_AC_truth_nFDpCD =
        hPlot1D("nFDpCD", "", "TL #phi^{truth}_{#gamma} AC", "#phi^{truth}_{#gamma} of Outgoing #gamma AC", "#phi^{truth}_{#gamma} [Deg]",
    ...
    hPlot1D hPhi_ph_BC_truth_nFDpCD =
        hPlot1D("nFDpCD", "", "TL #phi^{truth}_{#gamma} BC", "#phi^{truth}_{#gamma} of Outgoing #gamma BC", "#phi^{truth}_{#gamma} [Deg]",
    ...
    hPlot1D hPhi_ph_AC_truth_nFDpCD_FD =
        hPlot1D("nFDpCD", "FD", "FD TL #phi^{truth}_{#gamma} AC", "#phi^{truth}_{#gamma} of FD Outgoing #gamma AC", "#phi^{truth}_{#gamma} [Deg]",
    ...
    hPlot1D hPhi_ph_BC_truth_nFDpCD_FD =
        hPlot1D("nFDpCD", "FD", "FD TL #phi^{truth}_{#gamma} BC", "#phi^{truth}_{#gamma} of FD Outgoing #gamma BC", "#phi^{truth}_{#gamma} [Deg]",
    ...
    hPlot2D hTheta_nFD_vs_Phi_nFD_nFDpCD_BEC = hPlot2D("nFDpCD", "FD", "#theta_{nFD} vs. #phi_{nFD} BEC", "TL #theta_{nFD} vs. #phi_{nFD} BEC", "#phi_{nFD} [Deg]", "#theta_{nFD} [Deg]",
                                                       ...
                                                       Phi_uboundary, Theta_lboundary_FD, Theta_uboundary_FD, numTH2Dbins_Nucleon_Ang_eff_Plots, numTH2Dbins_Nucleon_Ang_eff_Plots);
    hPlot2D hTheta_nFD_vs_Phi_nFD_nFDpCD_AEC = hPlot2D("nFDpCD", "FD", "#theta_{nFD} vs. #phi_{nFD} AEC", "TL #theta_{nFD} vs. #phi_{nFD} AEC", "#phi_{nFD} [Deg]", "#theta_{nFD} [Deg]",
    ...
    hPlot2D hTheta_nFD_vs_Phi_nFD_truth_nFDpCD =
        hPlot2D("nFDpCD", "FD", "TL #theta_{nFD} vs. #phi_{nFD}", "TL #theta_{nFD} vs. #phi_{nFD}", "#phi_{nFD} [Deg]", "#theta_{nFD} [Deg]",
    ...
    hPlot2D hElectronAMapBC =
        hPlot2D("", "", "Electron_AMap_BC", "Electron AMap BC", "#phi_{e} [Deg]", "#theta_{e} [Deg]", directories.AMaps_Directory_map["AMaps_BC_1e_cut_Directory"], "01_Electron_AMap_BC",
    ...
    hPlot2D hProtonAMapBC =
        hPlot2D("", "", "Proton_AMap_BC", "Proton AMap BC", "#phi_{p} [Deg]", "#theta_{p} [Deg]", directories.AMaps_Directory_map["AMaps_BC_1e_cut_Directory"], "02_Proton_AMap_BC",
    ...
    hPlot2D hNeutronAMapBC =
        hPlot2D("", "", "Neutron_AMap_BC", "Neutron AMap BC", "#phi_{n} [Deg]", "#theta_{n} [Deg]", directories.AMaps_Directory_map["AMaps_BC_1e_cut_Directory"], "03_Neutron_AMap_BC",
                Phi_lboundary, Phi_uboundary, Theta_lboundary_FD, Theta_uboundary_FD, numTH2Dbins_Nucleon_AMaps_Plots, numTH2Dbins_Nucleon_AMaps_Plots);
    hPlot2D hNucleonAMapBC =
        hPlot2D("", "", "Nucleon_AMap_BC", "Nucleon AMap BC", "#phi_{nuc} [Deg]", "#theta_{nuc} [Deg]", directories.AMaps_Directory_map["AMaps_BC_1e_cut_Directory"], "04_Nucleon_AMap_BC",
                Phi_lboundary, Phi_uboundary, Theta_lboundary_FD, Theta_uboundary_FD, numTH2Dbins_Nucleon_AMaps_Plots, numTH2Dbins_Nucleon_AMaps_Plots);
    ...
    hPlot2D hElectronAMapBCwKC =
        hPlot2D("", "", "Electron_AMap_BCwKC", "Electron AMap BC wKC", "#phi_{e} [Deg]", "#theta_{e} [Deg]", directories.AMaps_Directory_map["WMaps_BC_1e_cut_Directory"],
    ...
    hPlot2D hProtonAMapBCwKC =
        hPlot2D("", "", "Proton_AMap_BCwKC", "Proton AMap BC wKC", "#phi_{p} [Deg]", "#theta_{p} [Deg]", directories.AMaps_Directory_map["WMaps_BC_1e_cut_Directory"], "02_Proton_AMap_BCwKC",
                Phi_lboundary, Phi_uboundary, Theta_lboundary_FD, Theta_uboundary_FD, numTH2Dbins_Nucleon_AMaps_Plots, numTH2Dbins_Nucleon_AMaps_Plots);
    hPlot2D hNeutronAMapBCwKC =
        hPlot2D("", "", "Neutron_AMap_BCwKC", "Neutron AMap BC wKC", "#phi_{n} [Deg]", "#theta_{n} [Deg]", directories.AMaps_Directory_map["WMaps_BC_1e_cut_Directory"],
    ...
    hPlot2D hNucleonAMapBCwKC =
        hPlot2D("", "", "Nucleon_AMap_BCwKC", "Nucleon AMap BC wKC", "#phi_{nuc} [Deg]", "#theta_{nuc} [Deg]", directories.AMaps_Directory_map["WMaps_BC_1e_cut_Directory"],
    ...
    hPlot1D hdTheta_pFD_TL_BC_1p =
        hPlot1D("1p", "FD", "TL #Delta#theta_{pFD} BC", "#Delta#theta_{pFD} of FD proton BC", "#Delta#theta_{pFD} = #theta^{rec}_{pFD} - #theta^{truth}_{pFD} [Deg]",
                directories.Resolution_Directory_map["Resolution_1p_Directory"], "00a_DeltaTheta_pFD_BC_TL_1p", -Theta_uboundary_FD, Theta_uboundary_FD, numTH1Dbins_nRes_Plots);
    hPlot1D hdTheta_pFD_TL_ZOOMIN_BC_1p =
        hPlot1D("1p", "FD", "TL #Delta#theta_{pFD} - ZOOMIN BC", "#Delta#theta_{pFD} of FD proton - ZOOMIN BC", "#Delta#theta_{pFD} = #theta^{rec}_{pFD} - #theta^{truth}_{pFD} [Deg]",
                directories.Resolution_Directory_map["Resolution_1p_Directory"], "00b_DeltaTheta_pFD_BC_TL_ZOOMIN_1p", -10.0, 10.0, numTH1Dbins_nRes_Plots);
    hPlot1D hdPhi_pFD_TL_BC_1p = hPlot1D("1p", "FD", "TL #Delta#phi_{pFD} BC", "#Delta#phi_{pFD} of FD proton BC", "#Delta#phi_{pFD} = #phi^{rec}_{pFD} - #phi^{truth}_{pFD} [Deg]",
                                         directories.Resolution_Directory_map["Resolution_1p_Directory"], "00c_DeltaPhi_pFD_BC_TL_1p", Phi_lboundary, Phi_uboundary, numTH1Dbins_nRes_Plots);
    hPlot1D hdPhi_pFD_TL_ZOOMIN_BC_1p =
        hPlot1D("1p", "FD", "TL #Delta#phi_{pFD} - ZOOMIN BC", "#Delta#phi_{pFD} of FD proton - ZOOMIN BC", "#Delta#phi_{pFD} = #phi^{rec}_{pFD} - #phi^{truth}_{pFD} [Deg]",
                directories.Resolution_Directory_map["Resolution_1p_Directory"], "00d_DeltaPhi_pFD_BC_TL_ZOOMIN_1p", -20, 20, numTH1Dbins_nRes_Plots);

    hPlot1D hdTheta_pFD_TL_AdPC_1p =
        hPlot1D("1p", "FD", "TL #Delta#theta_{pFD} AdPC", "#Delta#theta_{pFD} of FD proton AdPC", "#Delta#theta_{pFD} = #theta^{rec}_{pFD} - #theta^{truth}_{pFD} [Deg]",
                directories.Resolution_Directory_map["Resolution_1p_Directory"], "00e_DeltaTheta_pFD_AdPC_TL_1p", -Theta_uboundary_FD, Theta_uboundary_FD, numTH1Dbins_nRes_Plots);
    hPlot1D hdTheta_pFD_TL_ZOOMIN_AdPC_1p =
        hPlot1D("1p", "FD", "TL #Delta#theta_{pFD} - ZOOMIN AdPC", "#Delta#theta_{pFD} of FD proton - ZOOMIN AdPC", "#Delta#theta_{pFD} = #theta^{rec}_{pFD} - #theta^{truth}_{pFD} [Deg]",
                directories.Resolution_Directory_map["Resolution_1p_Directory"], "00f_DeltaTheta_pFD_AdPC_TL_ZOOMIN_1p", -10.0, 10.0, numTH1Dbins_nRes_Plots);
    hPlot1D hdPhi_pFD_TL_AdPC_1p =
        hPlot1D("1p", "FD", "TL #Delta#phi_{pFD} AdPC", "#Delta#phi_{pFD} of FD proton AdPC", "#Delta#phi_{pFD} = #phi^{rec}_{pFD} - #phi^{truth}_{pFD} [Deg]",
                directories.Resolution_Directory_map["Resolution_1p_Directory"], "00g_DeltaPhi_pFD_AdPC_TL_1p", Phi_lboundary, Phi_uboundary, numTH1Dbins_nRes_Plots);
    hPlot1D hdPhi_pFD_TL_ZOOMIN_AdPC_1p =
        hPlot1D("1p", "FD", "TL #Delta#phi_{pFD} - ZOOMIN AdPC", "#Delta#phi_{pFD} of FD proton - ZOOMIN AdPC", "#Delta#phi_{pFD} = #phi^{rec}_{pFD} - #phi^{truth}_{pFD} [Deg]",
                directories.Resolution_Directory_map["Resolution_1p_Directory"], "00h_DeltaPhi_pFD_AdPC_TL_ZOOMIN_1p", -20, 20, numTH1Dbins_nRes_Plots);

    hPlot1D hTheta_pFD_TL_ApResC_1p =
        hPlot1D("1p", "", "TL #theta^{truth}_{pFD} ApResC", "#theta^{truth}_{pFD} of FD proton ApResC", "#theta^{truth}_{pFD} [Deg]",
                directories.Resolution_Directory_map["Resolution_1p_Directory"], "01a_Theta_pFD_ApResC_TL_1p", Theta_lboundary_FD, Theta_uboundary_FD, numTH1Dbins_nRes_Plots);
    hPlot1D hPhi_pFD_TL_ApResC_1p =
        hPlot1D("1p", "", "TL #phi^{truth}_{pFD} ApResC", "#phi^{truth}_{pFD} of FD proton ApResC", "#phi^{truth}_{pFD} [Deg]",
                directories.Resolution_Directory_map["Resolution_1p_Directory"], "02a_Phi_pFD_ApResC_TL_1p", Phi_lboundary, Phi_uboundary, numTH1Dbins_nRes_Plots);
    ...
    hPlot1D hTheta_pFD_TL_MatchedP_1p =
        hPlot1D("1p", "", "TL #theta^{truth}_{pFD} of matched TL p", "#theta^{truth}_{pFD} of matched TL FD proton", "#theta^{truth}_{pFD} [Deg]",
                directories.Resolution_Directory_map["Resolution_1p_Directory"], "01b_Theta_pFD_MatchedN_TL_1p", Theta_lboundary_FD, Theta_uboundary_FD, numTH1Dbins_nRes_Plots);
    hPlot1D hPhi_pFD_TL_MatchedP_1p =
        hPlot1D("1p", "", "TL #phi^{truth}_{pFD} of matched TL p", "#phi^{truth}_{pFD} of matched TL FD proton", "#phi^{truth}_{pFD} [Deg]",
                directories.Resolution_Directory_map["Resolution_1p_Directory"], "02b_Phi_pFD_MatchedN_TL_1p", Phi_lboundary, Phi_uboundary, numTH1Dbins_nRes_Plots);
    ...
    hPlot1D hTheta_pFD_TL_1p =
        hPlot1D("1p", "", "TL #theta^{truth}_{pFD} AC", "#theta^{truth}_{pFD} of FD proton AC", "#theta^{truth}_{pFD} [Deg]", directories.Resolution_Directory_map["Resolution_1p_Directory"],
                "01_Theta_pFD_AC_TL_1p", Theta_lboundary_FD, Theta_uboundary_FD, numTH1Dbins_nRes_Plots);
    hPlot1D hPhi_pFD_TL_1p = hPlot1D("1p", "", "TL #phi^{truth}_{pFD} AC", "#phi^{truth}_{pFD} of FD proton AC", "#phi^{truth}_{pFD} [Deg]",
                                     directories.Resolution_Directory_map["Resolution_1p_Directory"], "02_Phi_pFD_AC_TL_1p", Phi_lboundary, Phi_uboundary, numTH1Dbins_nRes_Plots);
    ...
    TH2D *hP_pFD_Res_VS_TL_P_pFD_ZOOMIN_1p =
        new TH2D("P_{pFD} resolution AC vs. P^{truth}_{pFD} - ZOOMIN (1p, FD)",
    ...
    hPlot1D hdTheta_nFD_TL_BC_1n =
        hPlot1D("1n", "FD", "TL #Delta#theta_{nFD} BC", "#Delta#theta_{nFD} of FD neutron BC", "#Delta#theta_{nFD} = #theta^{rec}_{nFD} - #theta^{truth}_{nFD} [Deg]",
                directories.Resolution_Directory_map["Resolution_1n_Directory"], "00a_DeltaTheta_nFD_BC_TL_1n", -Theta_uboundary_FD, Theta_uboundary_FD, numTH1Dbins_nRes_Plots);
    hPlot1D hdTheta_nFD_TL_ZOOMIN_BC_1n =
        hPlot1D("1n", "FD", "TL #Delta#theta_{nFD} - ZOOMIN BC", "#Delta#theta_{nFD} of FD neutron - ZOOMIN BC", "#Delta#theta_{nFD} = #theta^{rec}_{nFD} - #theta^{truth}_{nFD} [Deg]",
                directories.Resolution_Directory_map["Resolution_1n_Directory"], "00b_DeltaTheta_nFD_BC_TL_ZOOMIN_1n", -10.0, 10.0, numTH1Dbins_nRes_Plots);
    hPlot1D hdPhi_nFD_TL_BC_1n = hPlot1D("1n", "FD", "TL #Delta#phi_{nFD} BC", "#Delta#phi_{nFD} of FD neutron BC", "#Delta#phi_{nFD} = #phi^{rec}_{nFD} - #phi^{truth}_{nFD} [Deg]",
                                         directories.Resolution_Directory_map["Resolution_1n_Directory"], "00c_DeltaPhi_nFD_BC_TL_1n", Phi_lboundary, Phi_uboundary, numTH1Dbins_nRes_Plots);
    hPlot1D hdPhi_nFD_TL_ZOOMIN_BC_1n =
        hPlot1D("1n", "FD", "TL #Delta#phi_{nFD} - ZOOMIN BC", "#Delta#phi_{nFD} of FD neutron - ZOOMIN BC", "#Delta#phi_{nFD} = #phi^{rec}_{nFD} - #phi^{truth}_{nFD} [Deg]",
                directories.Resolution_Directory_map["Resolution_1n_Directory"], "00d_DeltaPhi_nFD_BC_TL_ZOOMIN_1n", -20, 20, numTH1Dbins_nRes_Plots);

    hPlot1D hdTheta_nFD_TL_AdPC_1n =
        hPlot1D("1n", "FD", "TL #Delta#theta_{nFD} AdPC", "#Delta#theta_{nFD} of FD neutron AdPC", "#Delta#theta_{nFD} = #theta^{rec}_{nFD} - #theta^{truth}_{nFD} [Deg]",
                directories.Resolution_Directory_map["Resolution_1n_Directory"], "00e_DeltaTheta_nFD_AdPC_TL_1n", -Theta_uboundary_FD, Theta_uboundary_FD, numTH1Dbins_nRes_Plots);
    hPlot1D hdTheta_nFD_TL_ZOOMIN_AdPC_1n =
        hPlot1D("1n", "FD", "TL #Delta#theta_{nFD} - ZOOMIN AdPC", "#Delta#theta_{nFD} of FD neutron - ZOOMIN AdPC", "#Delta#theta_{nFD} = #theta^{rec}_{nFD} - #theta^{truth}_{nFD} [Deg]",
                directories.Resolution_Directory_map["Resolution_1n_Directory"], "00f_DeltaTheta_nFD_AdPC_TL_ZOOMIN_1n", -10.0, 10.0, numTH1Dbins_nRes_Plots);
    hPlot1D hdPhi_nFD_TL_AdPC_1n =
        hPlot1D("1n", "FD", "TL #Delta#phi_{nFD} AdPC", "#Delta#phi_{nFD} of FD neutron AdPC", "#Delta#phi_{nFD} = #phi^{rec}_{nFD} - #phi^{truth}_{nFD} [Deg]",
                directories.Resolution_Directory_map["Resolution_1n_Directory"], "00g_DeltaPhi_nFD_AdPC_TL_1n", Phi_lboundary, Phi_uboundary, numTH1Dbins_nRes_Plots);
    hPlot1D hdPhi_nFD_TL_ZOOMIN_AdPC_1n =
        hPlot1D("1n", "FD", "TL #Delta#phi_{nFD} - ZOOMIN AdPC", "#Delta#phi_{nFD} of FD neutron - ZOOMIN AdPC", "#Delta#phi_{nFD} = #phi^{rec}_{nFD} - #phi^{truth}_{nFD} [Deg]",
                directories.Resolution_Directory_map["Resolution_1n_Directory"], "00h_DeltaPhi_nFD_AdPC_TL_ZOOMIN_1n", -20, 20, numTH1Dbins_nRes_Plots);

    hPlot1D hTheta_nFD_TL_AnResC_1n =
        hPlot1D("1n", "", "TL #theta^{truth}_{nFD} AnResC", "#theta^{truth}_{nFD} of FD neutron AnResC", "#theta^{truth}_{nFD} [Deg]",
                directories.Resolution_Directory_map["Resolution_1n_Directory"], "01a_Theta_nFD_AnResC_TL_1n", Theta_lboundary_FD, Theta_uboundary_FD, numTH1Dbins_nRes_Plots);
    hPlot1D hPhi_nFD_TL_AnResC_1n =
        hPlot1D("1n", "", "TL #phi^{truth}_{nFD} AnResC", "#phi^{truth}_{nFD} of FD neutron AnResC", "#phi^{truth}_{nFD} [Deg]",
                directories.Resolution_Directory_map["Resolution_1n_Directory"], "02a_Phi_nFD_AnResC_TL_1n", Phi_lboundary, Phi_uboundary, numTH1Dbins_nRes_Plots);
    ...
    hPlot1D hTheta_nFD_TL_MatchedN_1n =
        hPlot1D("1n", "", "TL #theta^{truth}_{nFD} of matched TL n", "#theta^{truth}_{nFD} of matched TL FD neutron", "#theta^{truth}_{nFD} [Deg]",
                directories.Resolution_Directory_map["Resolution_1n_Directory"], "01b_Theta_nFD_MatchedN_TL_1n", Theta_lboundary_FD, Theta_uboundary_FD, numTH1Dbins_nRes_Plots);
    hPlot1D hPhi_nFD_TL_MatchedN_1n =
        hPlot1D("1n", "", "TL #phi^{truth}_{nFD} of matched TL n", "#phi^{truth}_{nFD} of matched TL FD neutron", "#phi^{truth}_{nFD} [Deg]",
                directories.Resolution_Directory_map["Resolution_1n_Directory"], "02b_Phi_nFD_MatchedN_TL_1n", Phi_lboundary, Phi_uboundary, numTH1Dbins_nRes_Plots);
    ...
    TH2D *hP_nFD_Res_VS_TL_P_nFD_ZOOMIN_1n =
        new TH2D("P_{nFD} resolution AC vs. P^{truth}_{nFD} - ZOOMIN (1n, FD)",
    ...
    TH2D *hP_nFD_Res_VS_Reco_P_nFD_ZOOMIN_1n =
        new TH2D("P_{nFD} resolution AC vs. P^{reco}_{nFD} - ZOOMIN (1n, FD)",
    ...
    hPlot1D hEff_dist_TL_1n = hPlot1D("1n", "FD", "Effective distance #font[12]{l}_{eff}^{TL} with #beta_{LT}", "Effective distance #font[12]{l}_{eff}^{TL} with #beta_{LT}",
                                      "#font[12]{l}_{eff}^{TL} [cm]", directories.Resolution_Directory_map["Resolution_1n_Directory"], "00XX_Eff_dist_TL_1n", -6000, 6000, numTH1Dbins);
    hPlot2D hEff_dist_TL_VS_TL_P_nFD_1n = hPlot2D("1n", "FD", "Effective distance #font[12]{l}_{eff}^{TL} with #beta_{LT} vs. P^{truth}_{nFD}",
                                                  "Effective distance #font[12]{l}_{eff}^{TL} with #beta_{LT} vs. P^{truth}_{nFD}", "#font[12]{l}_{eff}^{TL} [cm]", "P^{truth}_{nFD} [GeV/c]",
                                                  directories.Resolution_Directory_map["Resolution_1n_Directory"], "00XX_Eff_dist_TL_vs_TL_P_nFD_1n", -6000, 6000,
                                                  n_mom_th.GetLowerCut() * 0.95, 4 * 1.05, numTH2Dbins, numTH2Dbins);
    hPlot1D hddist_TL_1n =
        hPlot1D("1n", "FD", "#Delta#font[12]{l}_{eff}^{TL}", "#Delta#font[12]{l}_{eff}^{TL}", "#Delta#font[12]{l}_{eff}^{TL} = #font[12]{l}_{path} - #font[12]{l}_{eff}^{TL} [cm]",
    ...
    hPlot2D hddist_TL_VS_TL_P_nFD_1n = hPlot2D("1n", "FD", "#Delta#font[12]{l}_{eff}^{TL} vs. P^{truth}_{nFD}", "#Delta#font[12]{l}_{eff}^{TL} vs. P^{truth}_{nFD}",
                                               ...
                                               directories.Resolution_Directory_map["Resolution_1n_Directory"], "00XX_ddist_TL_vs_TL_P_nFD_1n", -6000, 6000, n_mom_th.GetLowerCut() * 0.95,
                                               4 * 1.05, numTH2Dbins, numTH2Dbins);

    hPlot1D hEff_dist_Reco_1n = hPlot1D("1n", "FD", "Effective distance #font[12]{l}_{eff}^{reco} with #beta_{reco}", "Effective distance #font[12]{l}_{eff}^{reco} with #beta_{LT}",
                                        "#font[12]{l}_{eff}^{reco} [cm]", directories.Resolution_Directory_map["Resolution_1n_Directory"], "00XX_Eff_dist_Reco_1n", -6000, 6000, numTH1Dbins);
    hPlot2D hEff_dist_Reco_VS_TL_P_nFD_1n = hPlot2D("1n", "FD", "Effective distance #font[12]{l}_{eff}^{reco} with #beta_{reco} vs. P^{truth}_{nFD}",
                                                    ...
                                                    "P^{truth}_{nFD} [GeV/c]", directories.Resolution_Directory_map["Resolution_1n_Directory"], "00XX_Eff_dist_Reco_vs_TL_P_nFD_1n", -6000,
                                                    6000, n_mom_th.GetLowerCut() * 0.95, 4 * 1.05, numTH2Dbins, numTH2Dbins);
    hPlot1D hddist_Reco_1n =
        hPlot1D("1n", "FD", "#Delta#font[12]{l}_{eff}^{reco}", "#Delta#font[12]{l}_{eff}^{reco}", "#Delta#font[12]{l}_{eff}^{reco} = #font[12]{l}_{path} - #font[12]{l}_{eff}^{reco} [cm]",
                directories.Resolution_Directory_map["Resolution_1n_Directory"], "00XX_ddist_reco_1n", -6000, 6000, numTH1Dbins);
    hPlot2D hddist_Reco_VS_TL_P_nFD_1n = hPlot2D("1n", "FD", "#Delta#font[12]{l}_{eff}^{reco} vs. P^{truth}_{nFD}", "#Delta#font[12]{l}_{eff}^{reco} vs. P^{truth}_{nFD}",
                                                 "#Delta#font[12]{l}_{eff}^{reco} = #font[12]{l}_{path} - #font[12]{l}_{eff}^{reco} [cm]", "P^{truth}_{nFD} [GeV/c]",
                                                 directories.Resolution_Directory_map["Resolution_1n_Directory"], "00XX_ddist_reco_vs_reco_P_nFD_1n", -6000, 6000,
                                                 n_mom_th.GetLowerCut() * 0.95, 4 * 1.05, numTH2Dbins, numTH2Dbins);

    hPlot1D hTOF_error_1n = hPlot1D("1n", "FD", "TOF Error #Deltat_{TOF}", "TOF Error #Deltat_{TOF}", "#Deltat_{TOF} [ns]", directories.Resolution_Directory_map["Resolution_1n_Directory"],
                                    "00XX_TOF_error_1n", -10., 10., numTH1Dbins);
    hPlot2D hTOF_error_VS_TL_P_nFD_1n = hPlot2D("1n", "FD", "TOF Error #Deltat_{TOF} vs. P^{truth}_{nFD}", "TOF Error #Deltat_{TOF} vs. P^{truth}_{nFD}", "#Deltat_{TOF} [ns]",
                                                "P^{truth}_{nFD} [GeV/c]", directories.Resolution_Directory_map["Resolution_1n_Directory"], "00XX_TOF_error_VS_TL_P_nFD_1n", -10., 10.,
                                                n_mom_th.GetLowerCut() * 0.95, 4 * 1.05, numTH2Dbins, numTH2Dbins);
    //</editor-fold>
    ...
    hPlot1D hMultiplicity_Neutrons_By_Redef_APID_BV_1e_cut_FD =
        hPlot1D("1e cut", "FD", "Multiplicity of neutrons by redef.  APID BV", "Multiplicity of neutrons by redef.  APID BV", "Multiplicity",
                directories.Multiplicity_Directory_map["Multiplicity_1e_cut_Directory"], "01_Multiplicity_Neutrons_By_Redef_APID_BV_1e_cut_FD", 0, 10, numTH1Dbins_Mom_eff_Plots);
    hPlot1D hMultiplicity_Neutrons_By_Redef_APID_AV_1e_cut_FD =
        hPlot1D("1e cut", "FD", "Multiplicity of neutrons by redef.  APID AV", "Multiplicity of neutrons by redef.  APID AV", "Multiplicity",
                directories.Multiplicity_Directory_map["Multiplicity_1e_cut_Directory"], "02_Multiplicity_Neutrons_By_Redef_APID_AV_1e_cut_FD", 0, 10, numTH1Dbins_Mom_eff_Plots);
    hPlot1D hMultiplicity_Neutrons_By_Redef_BPID_BV_1e_cut_FD =
        hPlot1D("1e cut", "FD", "Multiplicity of neutrons by redef.  BPID BV", "Multiplicity of neutrons by redef.  BPID BV", "Multiplicity",
                directories.Multiplicity_Directory_map["Multiplicity_1e_cut_Directory"], "03_Multiplicity_Neutrons_By_Redef_BPID_BV_1e_cut_FD", 0, 10, numTH1Dbins_Mom_eff_Plots);
    hPlot1D hMultiplicity_Neutrons_By_Redef_BPID_AV_1e_cut_FD =
        hPlot1D("1e cut", "FD", "Multiplicity of neutrons by redef.  BPID AV", "Multiplicity of neutrons by redef.  BPID AV", "Multiplicity",
                directories.Multiplicity_Directory_map["Multiplicity_1e_cut_Directory"], "04_Multiplicity_Neutrons_By_Redef_BPID_AV_1e_cut_FD", 0, 10, numTH1Dbins_Mom_eff_Plots);

    hPlot1D hMultiplicity_Neutrons_By_clas12pid_APID_BV_1e_cut_FD =
        hPlot1D("1e cut", "FD", "Multiplicity of neutrons by clas12pid  APID BV", "Multiplicity of neutrons by clas12pid  APID BV", "Multiplicity",
                directories.Multiplicity_Directory_map["Multiplicity_1e_cut_Directory"], "01_Multiplicity_Neutrons_By_clas12pid_APID_BV_1e_cut_FD", 0, 10, numTH1Dbins_Mom_eff_Plots);
    hPlot1D hMultiplicity_Neutrons_By_clas12pid_APID_AV_1e_cut_FD =
        hPlot1D("1e cut", "FD", "Multiplicity of neutrons by clas12pid  APID AV", "Multiplicity of neutrons by clas12pid  APID AV", "Multiplicity",
                directories.Multiplicity_Directory_map["Multiplicity_1e_cut_Directory"], "02_Multiplicity_Neutrons_By_clas12pid_APID_AV_1e_cut_FD", 0, 10, numTH1Dbins_Mom_eff_Plots);
    hPlot1D hMultiplicity_Neutrons_By_clas12pid_BPID_BV_1e_cut_FD =
        hPlot1D("1e cut", "FD", "Multiplicity of neutrons by clas12pid  BPID BV", "Multiplicity of neutrons by clas12pid  BPID BV", "Multiplicity",
                directories.Multiplicity_Directory_map["Multiplicity_1e_cut_Directory"], "03_Multiplicity_Neutrons_By_clas12pid_BPID_BV_1e_cut_FD", 0, 10, numTH1Dbins_Mom_eff_Plots);
    hPlot1D hMultiplicity_Neutrons_By_clas12pid_BPID_AV_1e_cut_FD =
        hPlot1D("1e cut", "FD", "Multiplicity of neutrons by clas12pid  BPID AV", "Multiplicity of neutrons by clas12pid  BPID AV", "Multiplicity",
                directories.Multiplicity_Directory_map["Multiplicity_1e_cut_Directory"], "04_Multiplicity_Neutrons_By_clas12pid_BPID_AV_1e_cut_FD", 0, 10, numTH1Dbins_Mom_eff_Plots);
    //</editor-fold>

    //<editor-fold desc="Resolution histograms (1p)">
    // TODO: need AV plots?
    hPlot1D hMultiplicity_Neutrons_By_Redef_APID_BV_1p_FD =
        hPlot1D("1p", "FD", "Multiplicity of neutrons by redef.  APID BV", "Multiplicity of neutrons by redef.  APID BV", "Multiplicity",
                directories.Multiplicity_Directory_map["Multiplicity_1p_Directory"], "01_Multiplicity_Neutrons_By_Redef_APID_BV_1p_FD", 0, 10, numTH1Dbins_Mom_eff_Plots);
    hPlot1D hMultiplicity_Neutrons_By_Redef_APID_AV_1p_FD =
        hPlot1D("1p", "FD", "Multiplicity of neutrons by redef.  APID AV", "Multiplicity of neutrons by redef.  APID AV", "Multiplicity",
                directories.Multiplicity_Directory_map["Multiplicity_1p_Directory"], "02_Multiplicity_Neutrons_By_Redef_APID_AV_1p_FD", 0, 10, numTH1Dbins_Mom_eff_Plots);
    hPlot1D hMultiplicity_Neutrons_By_Redef_BPID_BV_1p_FD =
        hPlot1D("1p", "FD", "Multiplicity of neutrons by redef.  BPID BV", "Multiplicity of neutrons by redef.  BPID BV", "Multiplicity",
                directories.Multiplicity_Directory_map["Multiplicity_1p_Directory"], "03_Multiplicity_Neutrons_By_Redef_BPID_BV_1p_FD", 0, 10, numTH1Dbins_Mom_eff_Plots);
    hPlot1D hMultiplicity_Neutrons_By_Redef_BPID_AV_1p_FD =
        hPlot1D("1p", "FD", "Multiplicity of neutrons by redef.  BPID AV", "Multiplicity of neutrons by redef.  BPID AV", "Multiplicity",
                directories.Multiplicity_Directory_map["Multiplicity_1p_Directory"], "04_Multiplicity_Neutrons_By_Redef_BPID_AV_1p_FD", 0, 10, numTH1Dbins_Mom_eff_Plots);
    //</editor-fold>

    //<editor-fold desc="Resolution histograms (1n)">
    // TODO: need AV plots?
    hPlot1D hMultiplicity_Neutrons_By_Redef_APID_BV_1n_FD =
        hPlot1D("1n", "FD", "Multiplicity of neutrons by redef.  APID BV", "Multiplicity of neutrons by redef.  APID BV", "Multiplicity",
                directories.Multiplicity_Directory_map["Multiplicity_1n_Directory"], "01_Multiplicity_Neutrons_By_Redef_APID_BV_1n_FD", 0, 10, numTH1Dbins_Mom_eff_Plots);
    hPlot1D hMultiplicity_Neutrons_By_Redef_APID_AV_1n_FD =
        hPlot1D("1n", "FD", "Multiplicity of neutrons by redef.  APID AV", "Multiplicity of neutrons by redef.  APID AV", "Multiplicity",
                directories.Multiplicity_Directory_map["Multiplicity_1n_Directory"], "02_Multiplicity_Neutrons_By_Redef_APID_AV_1n_FD", 0, 10, numTH1Dbins_Mom_eff_Plots);
    hPlot1D hMultiplicity_Neutrons_By_Redef_BPID_BV_1n_FD =
        hPlot1D("1n", "FD", "Multiplicity of neutrons by redef.  BPID BV", "Multiplicity of neutrons by redef.  BPID BV", "Multiplicity",
                directories.Multiplicity_Directory_map["Multiplicity_1n_Directory"], "03_Multiplicity_Neutrons_By_Redef_BPID_BV_1n_FD", 0, 10, numTH1Dbins_Mom_eff_Plots);
    hPlot1D hMultiplicity_Neutrons_By_Redef_BPID_AV_1n_FD =
        hPlot1D("1n", "FD", "Multiplicity of neutrons by redef.  BPID AV", "Multiplicity of neutrons by redef.  BPID AV", "Multiplicity",
                directories.Multiplicity_Directory_map["Multiplicity_1n_Directory"], "04_Multiplicity_Neutrons_By_Redef_BPID_AV_1n_FD", 0, 10, numTH1Dbins_Mom_eff_Plots);
    //</editor-fold>
