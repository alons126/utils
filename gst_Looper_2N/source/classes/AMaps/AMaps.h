...
class AMaps {
   ...
   public:
    ...
    AMaps(const string &AcceptanceMapsDirectory, const string &BeamE);
    ...
    void LoadAMapLimits(const char *filename, vector<vector<double>> &Loaded_particle_limits);

    // LoadAMapSlices function ----------------------------------------------------------------------------------------------------------------------------------------------------

    void LoadAMapSlices(const string &SampleName, const string &AcceptanceMapsDirectory, const string &Particle, const vector<vector<double>> &Loaded_particle_limits,
    ...
    // LoadBinaryAMapMatrices function ----------------------------------------------------------------------------------------------------------------------------------------------------

    void LoadBinaryAMapMatrices(const char *filename, vector<vector<int>> &Loaded_particle_AMap);
