...
class AMaps {
   public:
    ...
    void DrawAndSaveMapsBySliceToPDFs(vector<TObject*> HistoList, const std::string& PDFfileName);
    ...
    void ReadAMapSlices(const std::string& SampleName, const std::string& AcceptanceMapsDirectory, const std::string& Particle, const vector<vector<double>>& Loaded_particle_limits,
                        vector<vector<vector<int>>>& Loaded_Particle_AMap_Slices, const bool Special_maps = false);
   ...
   private:
    ...
    vector<hPlot2D> truth_theta_e_VS_phi_e_BySlice, truth_theta_p_VS_phi_p_BySlice, truth_theta_n_VS_phi_n_BySlice, truth_theta_n_VS_phi_n_ByConstSlice;
    hPlot2D truth_theta_n_VS_phi_n;
    vector<TObject*> truth_e_BySlice, truth_p_BySlice, truth_n_BySlice, truth_n_ByConstSlice;

    /* Reco. Acceptance maps */
    vector<hPlot2D> reco_theta_e_VS_phi_e_BySlice, reco_theta_p_VS_phi_p_BySlice, reco_theta_n_VS_phi_n_BySlice, reco_theta_n_VS_phi_n_ByConstSlice;
    hPlot2D reco_theta_n_VS_phi_n;
    vector<TObject*> reco_e_BySlice, reco_p_BySlice, reco_n_BySlice, reco_n_ByConstSlice;

    /* Reco./TL ratio maps */
    vector<hPlot2D> acceptance_eff_e_BySlice, acceptance_eff_p_BySlice, acceptance_eff_n_BySlice, acceptance_eff_n_ByConstSlice;
    hPlot2D acceptance_eff_n;
    vector<TObject*> acc_eff_e_BySlice, acc_eff_p_BySlice, acc_eff_n_BySlice, acc_eff_n_ByConstSlice;

    /* Separated acceptance & weight maps (= reco. above ratio th.) */
    vector<hPlot2D> filtered_reco_theta_e_VS_phi_e_BySlice, filtered_reco_theta_p_VS_phi_p_BySlice, filtered_reco_theta_n_VS_phi_n_BySlice,
        filtered_reco_theta_n_VS_phi_n_ByConstSlice;  // separated AMaps for each slice
    vector<TObject*> filtered_reco_e_BySlice, filtered_reco_p_BySlice, filtered_reco_n_BySlice, filtered_reco_n_ByConstSlice;
    ...
    vector<vector<vector<int>>> e_AMap_Slices, e_AMap_Slices_extended;
    vector<vector<int>> p_AMap;
    vector<vector<vector<int>>> p_AMap_Slices;
    vector<vector<int>> n_AMap;
    vector<vector<vector<int>>> n_AMap_Slices, n_AMap_ConstSlices;
    ...
    vector<vector<vector<double>>> n_WMap_Slices, n_WMap_ConstSlices;
    ...
    vector<TObject*> AMap_TL_HistoList, AMap_ConstTL_HistoList;
    vector<TObject*> AMap_Reco_HistoList, AMap_ConstReco_HistoList;
    vector<TObject*> AMap_Ratio_HistoList, AMap_ConstRatio_HistoList;
    vector<TObject*> cPart_Sep_AMaps_HistoList, nPart_Sep_AMaps_HistoList_Const;
    ...
    vector<vector<vector<int>>> Loaded_n_AMap_ConstSlices;
    ...
    vector<vector<vector<double>>> Loaded_n_WMap_ConstSlices;
