...
/**
 * @class Directories
 * @brief A class for managing directories for saving plots and histograms, including functions for creating directories for different types of cuts and plots.
 * @details The Directories class is designed to manage the directories for saving plots and histograms generated during the analysis. The class includes functions for creating directories
 * for different types of cuts (e.g., Nphe cuts, chi2 cuts, vertex cuts, sampling fraction cuts, edge cuts, momentum threshold cuts) and for different types of plots (e.g., 1e cut, 1p, 1n,
 * 2p, pFDpCD, nFDpCD). The class also includes a function for clearing old directories if the ClearOldDirectories flag is set to true. The Directories class is used in the main code for
 * managing the directories for saving plots and histograms, which helps to keep the output organized and easily accessible for analysis and presentation.
 * @note The Directories class is designed to be flexible and adaptable to different analysis configurations. It is important to set the parameters for the class appropriately based on the
 * goals of the analysis and the characteristics of the data being analyzed. For example, the ClearOldDirectories flag can be set to true or false based on whether you want to clear old
 * directories before creating new ones. Additionally, the settings for creating directories for different types of cuts and plots can be adjusted based on the specific cuts and plots that
 * are relevant for your analysis. It is important to use this class consistently throughout the code to ensure that the directories for saving plots and histograms are managed correctly and
 * that the output is organized in a way that facilitates analysis and presentation.
 */
class Directories {
   private:
    ...
    std::vector<std::string> Nphe_Daughter_Folders = {"", "01_1e_cut", "02_1p", "03_1n", "04_2p", "05_pFDpCD", "06_nFDpCD"};
    #pragma endregion
    ...
    std::vector<std::string> Chi2_Daughter_Folders = {"", "00_All_e", "01_1e_cut", "02_1p", "03_1n",
    ...
    std::vector<std::string> Vertex_Daughter_Folders = {"",
    ...
    std::vector<std::string> SF_Daughter_Folders = {
        "",
    ...
    std::vector<std::string> ECAL_Fiducial_Daughter_Folders = {"",
    ...
    std::vector<std::string> Momentum_Daughter_Folders = {
    ...
    std::vector<std::string> ReacMon_Daughter_Folders = {"",  //
                                                         "02_1p",
    ...
    std::vector<std::string> W_Daughter_Folders = {"", "01_1e_cut", "02_1p", "03_1n", "04_2p", "05_pFDpCD", "06_nFDpCD"};
    #pragma endregion

    #pragma region /* Beta plots directories */
    bool create_Beta_Dir = true;
    std::string Beta_Parent_Directory = "04_Beta_plots";
    std::vector<std::string> Beta_Daughter_Folders = {"",
                                                      "01_Beta_fit_plots",
    ...
    std::vector<std::string> Angle_Daughter_Folders = {"",
    ...
    std::vector<std::string> Momentum_transfer_Daughter_Folders = {"", "00_All_e", "01_1e_cut", "02_1p", "03_1n", "04_2p", "05_pFDpCD", "06_nFDpCD"};
    #pragma endregion

    #pragma region /* E_e plots directories */
    bool create_E_e_Dir = true;
    std::string E_e_Parent_Directory = "07_E_e_plots";
    std::vector<std::string> E_e_Daughter_Folders = {"",
                                                     "01_1e_cut",
    ...
    std::vector<std::string> Omega_Daughter_Folders = {"",
                                                       "02_1p",
    ...
    std::vector<std::string> Ecal_Daughter_Folders = {"",
                                                      "02_1p",
    ...
    std::vector<std::string> TKI_Daughter_Folders = {"",
                                                     "03_1n",
                                                     "03_1n/01_dP_T_1n",
    ...
    std::vector<std::string> ToF_Daughter_Folders = {"", "01_1e_cut", "01_1e_cut/01_Neutron_vs_cParticles_hits_FTOF_1e_cut", "06_nFDpCD",
                                                     "06_nFDpCD/01_Neutron_vs_cParticles_hits_FTOF_nFDpCD"};
    #pragma endregion
    ...
    std::vector<std::string> Eff_and_ACorr_Daughter_Folders = {
        "",
        "01_1e_cut",
        ...
        "01_1e_cut/04_Hit_std::maps",
        "01_1e_cut/05_Loaded_reco_ref_hit_std::maps",
        ...
        "05_pFDpCD/04_Proton_FD_Hit_std::map_pFDpCD",
        ...
        "06_nFDpCD/04_Neutron_FD_Hit_std::map_nFDpCD",
    };
    #pragma endregion

    #pragma region /* Acceptance std::maps plots directories */
    bool create_Acceptance_std::maps_Dir = true;
    std::string Astd::maps_Parent_Directory = "13_Acceptance_std::maps_plots";
    std::vector<std::string> Hit_std::maps_Daughter_Folders = {
        "",
        "01_Astd::maps_1e_cut",
        "01_Astd::maps_1e_cut/00a_Astd::maps_BC_from_file",

        "02_Wstd::maps_1e_cut",
        "02_Wstd::maps_1e_cut/00a_Wstd::maps_BC_from_file",
    };
    #pragma endregion
    ...
    std::vector<std::string> Resolution_Daughter_Folders = {
        "",
        "02_1p",
    ...
    std::vector<std::string> Multiplicity_Daughter_Folders = {
    ...
    bool FindSubstd::string(const std::string& std::string1, const std::string& std::string2) const;

    std::string Find(const std::vector<std::string>& std::vector, const std::string& std::string) const;

    std::string BuildPath(const std::string& base_folder, const std::string& parent_folder, const std::string& daughter_folder = "") const;

    void CreateDirectories(const bool Create_Directory, const std::string& Plots_Parent_Folder, const std::vector<std::string>& daughter_folders, const bool Clear_Parent_Folder_content,
                           const std::string& Parent_Folder);

    std::string FindCached(const std::vector<std::string>& std::vector, const std::string& std::string) const;

    void SetDirectory(std::map<std::string, std::string>& directory_std::map, const std::string& std::map_key, const std::string& base_folder, const std::string& parent_folder,
                      const std::vector<std::string>& daughter_folders, const std::string& daughter_key) const;

    mutable std::map<const std::vector<std::string>*, std::map<std::string, std::string>> find_cache_;

   public:
    std::map<std::string, std::string> Nphe_dir_std::map;
    std::map<std::string, std::string> Chi2_dir_std::map;
    std::map<std::string, std::string> Vertex_dir_std::map;
    std::map<std::string, std::string> SF_dir_std::map;
    std::map<std::string, std::string> ECAL_fiducial_dir_std::map;
    std::map<std::string, std::string> Momentum_dir_std::map;

    std::map<std::string, std::string> ReacMon_dir_std::map;
    std::map<std::string, std::string> W_dir_std::map;
    std::map<std::string, std::string> Beta_dir_std::map;
    std::map<std::string, std::string> Angle_dir_std::map;
    std::map<std::string, std::string> Momentum_transfer_dir_std::map;
    std::map<std::string, std::string> E_e_dir_std::map;
    std::map<std::string, std::string> Omega_dir_std::map;
    std::map<std::string, std::string> Ecal_dir_std::map;
    std::map<std::string, std::string> TKI_dir_std::map;
    std::map<std::string, std::string> ToF_dir_std::map;
    std::map<std::string, std::string> Eff_and_ACorr_dir_std::map;
    std::map<std::string, std::string> Astd::maps_dir_std::map;
    std::map<std::string, std::string> Resolution_dir_std::map;
    std::map<std::string, std::string> Multiplicity_dir_std::map;
