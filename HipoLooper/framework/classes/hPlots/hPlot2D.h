...
class hPlot2D {
   ...
   public:
    ...
    void histPlotter2D(const std::string &SampleName, TCanvas *HistogramCanvas, TH2D *Histogram2D, TList *Histogram_list, std::vector<TObject *> &HistoList, std::string Histogram2DSaveNameDir,
