...
//        } else if (file_name == "general_file") { // general_file (12C_2222GeV_G18_10a_02_11a_wfsi.root)
//            f = (TFile*)gROOT->GetListOfFiles()->FindObject("/mnt/d/NRG/root_data_files/fsiStudy/12C_2222GeV_G18_10a_02_11a_wfsi.root");
//            if (!f || !f->IsOpen()) {
//                f = new TFile("/mnt/d/NRG/root_data_files/fsiStudy/12C_2222GeV_G18_10a_02_11a_wfsi.root");
//            }
//        }

//        } else if (file_name == "general_file") { // general_file (12C_2222GeV_G18_10a_02_11a_nofsi.root)
//            f = (TFile*)gROOT->GetListOfFiles()->FindObject("/mnt/d/NRG/root_data_files/fsiStudy/12C_2222GeV_G18_10a_02_11a_nofsi.root");
//            if (!f || !f->IsOpen()) {
//                f = new TFile("/mnt/d/NRG/root_data_files/fsiStudy/12C_2222GeV_G18_10a_02_11a_nofsi.root");
//            }
//        }
...
//            std::string InputHipoFiles = "asportes_11_1000060120_2222_wfsi_SuSAv2_fixed_seed_555_test_17.gst.root";

            f = (TFile*)gROOT->GetListOfFiles()->FindObject(InputHipoFiles.c_str());
            if (!f || !f->IsOpen()) {
                f = new TFile(InputHipoFiles.c_str());
            }
        }
