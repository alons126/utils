 ...
 */
double Calc_Sol_dPhi(const std::vector<clas12::region_part_ptr>& electrons, const double& B, const double& L) {
 ...
 */
TVector3 Get_shifted_e_unit_v_NeutVeto(const std::vector<clas12::region_part_ptr>& electrons, const TVector3& v_nhit, const double& B, const double& L) {
